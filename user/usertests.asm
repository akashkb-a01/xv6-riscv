...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	d3a50513          	addi	a0,a0,-710 # 5d78 <malloc+0xec>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	68878793          	addi	a5,a5,1672 # 96e0 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	d9068693          	addi	a3,a3,-624 # bdf0 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	d1850513          	addi	a0,a0,-744 # 5d98 <malloc+0x10c>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d0850513          	addi	a0,a0,-760 # 5db0 <malloc+0x124>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d0a50513          	addi	a0,a0,-758 # 5dd0 <malloc+0x144>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	cd250513          	addi	a0,a0,-814 # 5db8 <malloc+0x12c>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	cde50513          	addi	a0,a0,-802 # 5de0 <malloc+0x154>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	cdc50513          	addi	a0,a0,-804 # 5e08 <malloc+0x17c>
     134:	00005097          	auipc	ra,0x5
     138:	75e080e7          	jalr	1886(ra) # 5892 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	cc850513          	addi	a0,a0,-824 # 5e08 <malloc+0x17c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	cc458593          	addi	a1,a1,-828 # 5e18 <malloc+0x18c>
     15c:	00005097          	auipc	ra,0x5
     160:	706080e7          	jalr	1798(ra) # 5862 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ca050513          	addi	a0,a0,-864 # 5e08 <malloc+0x17c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	ca458593          	addi	a1,a1,-860 # 5e20 <malloc+0x194>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c7450513          	addi	a0,a0,-908 # 5e08 <malloc+0x17c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c5e50513          	addi	a0,a0,-930 # 5e28 <malloc+0x19c>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	bd450513          	addi	a0,a0,-1068 # 5e50 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	bc0a8a93          	addi	s5,s5,-1088 # 5e50 <malloc+0x1c4>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	b58a0a13          	addi	s4,s4,-1192 # bdf0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b4e50513          	addi	a0,a0,-1202 # 5e60 <malloc+0x1d4>
     ...
     338:	b4c50513          	addi	a0,a0,-1204 # 5e80 <malloc+0x1f4>
     33c:	00006097          	auipc	ra,0x6
     340:	898080e7          	jalr	-1896(ra) # 5bd4 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	b28a0a13          	addi	s4,s4,-1240 # 5e98 <malloc+0x20c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	a8450513          	addi	a0,a0,-1404 # 5ea0 <malloc+0x214>
     424:	00005097          	auipc	ra,0x5
     428:	7b0080e7          	jalr	1968(ra) # 5bd4 <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	a7e50513          	addi	a0,a0,-1410 # 5eb8 <malloc+0x22c>
     442:	00005097          	auipc	ra,0x5
     446:	792080e7          	jalr	1938(ra) # 5bd4 <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	a9050513          	addi	a0,a0,-1392 # 5ee8 <malloc+0x25c>
     460:	00005097          	auipc	ra,0x5
     464:	774080e7          	jalr	1908(ra) # 5bd4 <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	aa650513          	addi	a0,a0,-1370 # 5f18 <malloc+0x28c>
     47a:	00005097          	auipc	ra,0x5
     47e:	75a080e7          	jalr	1882(ra) # 5bd4 <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	a9850513          	addi	a0,a0,-1384 # 5f28 <malloc+0x29c>
     498:	00005097          	auipc	ra,0x5
     49c:	73c080e7          	jalr	1852(ra) # 5bd4 <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	a8aa0a13          	addi	s4,s4,-1398 # 5f58 <malloc+0x2cc>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	94aa8a93          	addi	s5,s5,-1718 # 5e20 <malloc+0x194>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	9e450513          	addi	a0,a0,-1564 # 5f60 <malloc+0x2d4>
     584:	00005097          	auipc	ra,0x5
     588:	650080e7          	jalr	1616(ra) # 5bd4 <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	9de50513          	addi	a0,a0,-1570 # 5f78 <malloc+0x2ec>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	632080e7          	jalr	1586(ra) # 5bd4 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	96450513          	addi	a0,a0,-1692 # 5f18 <malloc+0x28c>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	618080e7          	jalr	1560(ra) # 5bd4 <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	9da50513          	addi	a0,a0,-1574 # 5fa8 <malloc+0x31c>
     5d6:	00005097          	auipc	ra,0x5
     5da:	5fe080e7          	jalr	1534(ra) # 5bd4 <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	9d450513          	addi	a0,a0,-1580 # 5fc0 <malloc+0x334>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	5e0080e7          	jalr	1504(ra) # 5bd4 <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	7d658593          	addi	a1,a1,2006 # 5e18 <malloc+0x18c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	7aa50513          	addi	a0,a0,1962 # 5e08 <malloc+0x17c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	77e50513          	addi	a0,a0,1918 # 5e08 <malloc+0x17c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	76a50513          	addi	a0,a0,1898 # 5e08 <malloc+0x17c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	97458593          	addi	a1,a1,-1676 # 6050 <malloc+0x3c4>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	6ea50513          	addi	a0,a0,1770 # 5e08 <malloc+0x17c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	88e50513          	addi	a0,a0,-1906 # 5ff0 <malloc+0x364>
     76a:	00005097          	auipc	ra,0x5
     76e:	46a080e7          	jalr	1130(ra) # 5bd4 <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	89250513          	addi	a0,a0,-1902 # 6010 <malloc+0x384>
     786:	00005097          	auipc	ra,0x5
     78a:	44e080e7          	jalr	1102(ra) # 5bd4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	88e50513          	addi	a0,a0,-1906 # 6020 <malloc+0x394>
     79a:	00005097          	auipc	ra,0x5
     79e:	43a080e7          	jalr	1082(ra) # 5bd4 <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	89250513          	addi	a0,a0,-1902 # 6040 <malloc+0x3b4>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	41e080e7          	jalr	1054(ra) # 5bd4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	85e50513          	addi	a0,a0,-1954 # 6020 <malloc+0x394>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	40a080e7          	jalr	1034(ra) # 5bd4 <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	87850513          	addi	a0,a0,-1928 # 6058 <malloc+0x3cc>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	3ec080e7          	jalr	1004(ra) # 5bd4 <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	87a50513          	addi	a0,a0,-1926 # 6078 <malloc+0x3ec>
     806:	00005097          	auipc	ra,0x5
     80a:	3ce080e7          	jalr	974(ra) # 5bd4 <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	86650513          	addi	a0,a0,-1946 # 6098 <malloc+0x40c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	87698993          	addi	s3,s3,-1930 # 60c0 <malloc+0x434>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	8a6a8a93          	addi	s5,s5,-1882 # 60f8 <malloc+0x46c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	80050513          	addi	a0,a0,-2048 # 6098 <malloc+0x40c>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	53e58593          	addi	a1,a1,1342 # bdf0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	7c450513          	addi	a0,a0,1988 # 6098 <malloc+0x40c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	7a250513          	addi	a0,a0,1954 # 60a0 <malloc+0x414>
     906:	00005097          	auipc	ra,0x5
     90a:	2ce080e7          	jalr	718(ra) # 5bd4 <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	7b450513          	addi	a0,a0,1972 # 60d0 <malloc+0x444>
     924:	00005097          	auipc	ra,0x5
     928:	2b0080e7          	jalr	688(ra) # 5bd4 <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	7ce50513          	addi	a0,a0,1998 # 6108 <malloc+0x47c>
     942:	00005097          	auipc	ra,0x5
     946:	292080e7          	jalr	658(ra) # 5bd4 <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	7da50513          	addi	a0,a0,2010 # 6130 <malloc+0x4a4>
     95e:	00005097          	auipc	ra,0x5
     962:	276080e7          	jalr	630(ra) # 5bd4 <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	7de50513          	addi	a0,a0,2014 # 6150 <malloc+0x4c4>
     97a:	00005097          	auipc	ra,0x5
     97e:	25a080e7          	jalr	602(ra) # 5bd4 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	7da50513          	addi	a0,a0,2010 # 6168 <malloc+0x4dc>
     996:	00005097          	auipc	ra,0x5
     99a:	23e080e7          	jalr	574(ra) # 5bd4 <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	7c850513          	addi	a0,a0,1992 # 6188 <malloc+0x4fc>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	41c90913          	addi	s2,s2,1052 # bdf0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	77650513          	addi	a0,a0,1910 # 6188 <malloc+0x4fc>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	3ca90913          	addi	s2,s2,970 # bdf0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	73650513          	addi	a0,a0,1846 # 6190 <malloc+0x504>
     a62:	00005097          	auipc	ra,0x5
     a66:	172080e7          	jalr	370(ra) # 5bd4 <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	73850513          	addi	a0,a0,1848 # 61b0 <malloc+0x524>
     a80:	00005097          	auipc	ra,0x5
     a84:	154080e7          	jalr	340(ra) # 5bd4 <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	74450513          	addi	a0,a0,1860 # 61d8 <malloc+0x54c>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	138080e7          	jalr	312(ra) # 5bd4 <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	6c850513          	addi	a0,a0,1736 # 6188 <malloc+0x4fc>
     ...
     af0:	70c50513          	addi	a0,a0,1804 # 61f8 <malloc+0x56c>
     af4:	00005097          	auipc	ra,0x5
     af8:	0e0080e7          	jalr	224(ra) # 5bd4 <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	71650513          	addi	a0,a0,1814 # 6220 <malloc+0x594>
     b12:	00005097          	auipc	ra,0x5
     b16:	0c2080e7          	jalr	194(ra) # 5bd4 <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	71050513          	addi	a0,a0,1808 # 6238 <malloc+0x5ac>
     b30:	00005097          	auipc	ra,0x5
     b34:	0a4080e7          	jalr	164(ra) # 5bd4 <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	71c50513          	addi	a0,a0,1820 # 6260 <malloc+0x5d4>
     b4c:	00005097          	auipc	ra,0x5
     b50:	088080e7          	jalr	136(ra) # 5bd4 <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	70650513          	addi	a0,a0,1798 # 6278 <malloc+0x5ec>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	71e58593          	addi	a1,a1,1822 # 62a8 <malloc+0x61c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	6d250513          	addi	a0,a0,1746 # 6278 <malloc+0x5ec>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	6bc50513          	addi	a0,a0,1724 # 6278 <malloc+0x5ec>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	6a650513          	addi	a0,a0,1702 # 6278 <malloc+0x5ec>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	70a58593          	addi	a1,a1,1802 # 62f0 <malloc+0x664>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	1ee58593          	addi	a1,a1,494 # bdf0 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	62a50513          	addi	a0,a0,1578 # 6278 <malloc+0x5ec>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	61a50513          	addi	a0,a0,1562 # 6288 <malloc+0x5fc>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f5e080e7          	jalr	-162(ra) # 5bd4 <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	62650513          	addi	a0,a0,1574 # 62b0 <malloc+0x624>
     c92:	00005097          	auipc	ra,0x5
     c96:	f42080e7          	jalr	-190(ra) # 5bd4 <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	62a50513          	addi	a0,a0,1578 # 62d0 <malloc+0x644>
     cae:	00005097          	auipc	ra,0x5
     cb2:	f26080e7          	jalr	-218(ra) # 5bd4 <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	63650513          	addi	a0,a0,1590 # 62f8 <malloc+0x66c>
     cca:	00005097          	auipc	ra,0x5
     cce:	f0a080e7          	jalr	-246(ra) # 5bd4 <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	63a50513          	addi	a0,a0,1594 # 6318 <malloc+0x68c>
     ce6:	00005097          	auipc	ra,0x5
     cea:	eee080e7          	jalr	-274(ra) # 5bd4 <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	63e50513          	addi	a0,a0,1598 # 6338 <malloc+0x6ac>
     d02:	00005097          	auipc	ra,0x5
     d06:	ed2080e7          	jalr	-302(ra) # 5bd4 <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	54a58593          	addi	a1,a1,1354 # 62a8 <malloc+0x61c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	5e258593          	addi	a1,a1,1506 # 6360 <malloc+0x6d4>
     d86:	00005517          	auipc	a0,0x5
     d8a:	5d250513          	addi	a0,a0,1490 # 6358 <malloc+0x6cc>
  ...
  unlink("lf1");
     ...
     d9e:	5be50513          	addi	a0,a0,1470 # 6358 <malloc+0x6cc>
     da2:	00005097          	auipc	ra,0x5
     da6:	af0080e7          	jalr	-1296(ra) # 5892 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	5ac50513          	addi	a0,a0,1452 # 6358 <malloc+0x6cc>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	59e50513          	addi	a0,a0,1438 # 6360 <malloc+0x6d4>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	01658593          	addi	a1,a1,22 # bdf0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	56658593          	addi	a1,a1,1382 # 6360 <malloc+0x6d4>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	55050513          	addi	a0,a0,1360 # 6360 <malloc+0x6d4>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a7a080e7          	jalr	-1414(ra) # 5892 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	53858593          	addi	a1,a1,1336 # 6358 <malloc+0x6cc>
     e28:	00005517          	auipc	a0,0x5
     e2c:	53850513          	addi	a0,a0,1336 # 6360 <malloc+0x6d4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	51c58593          	addi	a1,a1,1308 # 6358 <malloc+0x6cc>
     e44:	00005517          	auipc	a0,0x5
     e48:	62450513          	addi	a0,a0,1572 # 6468 <malloc+0x7dc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	50250513          	addi	a0,a0,1282 # 6368 <malloc+0x6dc>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d66080e7          	jalr	-666(ra) # 5bd4 <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	4fe50513          	addi	a0,a0,1278 # 6380 <malloc+0x6f4>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d4a080e7          	jalr	-694(ra) # 5bd4 <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	4fa50513          	addi	a0,a0,1274 # 6398 <malloc+0x70c>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d2e080e7          	jalr	-722(ra) # 5bd4 <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	4fe50513          	addi	a0,a0,1278 # 63b8 <malloc+0x72c>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	d12080e7          	jalr	-750(ra) # 5bd4 <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	51250513          	addi	a0,a0,1298 # 63e8 <malloc+0x75c>
     ede:	00005097          	auipc	ra,0x5
     ee2:	cf6080e7          	jalr	-778(ra) # 5bd4 <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	50e50513          	addi	a0,a0,1294 # 6400 <malloc+0x774>
     efa:	00005097          	auipc	ra,0x5
     efe:	cda080e7          	jalr	-806(ra) # 5bd4 <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	50a50513          	addi	a0,a0,1290 # 6418 <malloc+0x78c>
     f16:	00005097          	auipc	ra,0x5
     f1a:	cbe080e7          	jalr	-834(ra) # 5bd4 <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	51650513          	addi	a0,a0,1302 # 6440 <malloc+0x7b4>
     f32:	00005097          	auipc	ra,0x5
     f36:	ca2080e7          	jalr	-862(ra) # 5bd4 <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	52a50513          	addi	a0,a0,1322 # 6470 <malloc+0x7e4>
     f4e:	00005097          	auipc	ra,0x5
     f52:	c86080e7          	jalr	-890(ra) # 5bd4 <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	4e4a0a13          	addi	s4,s4,1252 # 6490 <malloc+0x804>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	49250513          	addi	a0,a0,1170 # 6490 <malloc+0x804>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	42a50513          	addi	a0,a0,1066 # 6498 <malloc+0x80c>
    1076:	00005097          	auipc	ra,0x5
    107a:	b5e080e7          	jalr	-1186(ra) # 5bd4 <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	42a50513          	addi	a0,a0,1066 # 64b8 <malloc+0x82c>
    1096:	00005097          	auipc	ra,0x5
    109a:	b3e080e7          	jalr	-1218(ra) # 5bd4 <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	42e50513          	addi	a0,a0,1070 # 64d8 <malloc+0x84c>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	b22080e7          	jalr	-1246(ra) # 5bd4 <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	41c98993          	addi	s3,s3,1052 # 64f8 <malloc+0x86c>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	3f050513          	addi	a0,a0,1008 # 6508 <malloc+0x87c>
    1120:	00005097          	auipc	ra,0x5
    1124:	ab4080e7          	jalr	-1356(ra) # 5bd4 <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	4884b483          	ld	s1,1160(s1) # 85c8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	addi	s1,s1,848 # c350 <buf+0x560>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	c2c98993          	addi	s3,s3,-980 # 5db0 <malloc+0x124>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	4f278793          	addi	a5,a5,1266 # 7700 <malloc+0x1a74>
  ...
  if(pid == 0){
    ...
    1248:	49478793          	addi	a5,a5,1172 # 86d8 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	48c68693          	addi	a3,a3,1164 # 96d8 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	46078b23          	sb	zero,1142(a5) # 96d8 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	ed678793          	addi	a5,a5,-298 # 8140 <malloc+0x24b4>
    ...
    1292:	b2250513          	addi	a0,a0,-1246 # 5db0 <malloc+0x124>
    ...
    12aa:	30a50513          	addi	a0,a0,778 # 65b0 <malloc+0x924>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	926080e7          	jalr	-1754(ra) # 5bd4 <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	26250513          	addi	a0,a0,610 # 6528 <malloc+0x89c>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	906080e7          	jalr	-1786(ra) # 5bd4 <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	26250513          	addi	a0,a0,610 # 6548 <malloc+0x8bc>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	8e6080e7          	jalr	-1818(ra) # 5bd4 <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	26050513          	addi	a0,a0,608 # 6568 <malloc+0x8dc>
    1310:	00005097          	auipc	ra,0x5
    1314:	8c4080e7          	jalr	-1852(ra) # 5bd4 <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	26850513          	addi	a0,a0,616 # 6590 <malloc+0x904>
    1330:	00005097          	auipc	ra,0x5
    1334:	8a4080e7          	jalr	-1884(ra) # 5bd4 <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	6e650513          	addi	a0,a0,1766 # 6a28 <malloc+0xd9c>
    134a:	00005097          	auipc	ra,0x5
    134e:	88a080e7          	jalr	-1910(ra) # 5bd4 <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	24c50513          	addi	a0,a0,588 # 65d8 <malloc+0x94c>
    1394:	00005097          	auipc	ra,0x5
    1398:	840080e7          	jalr	-1984(ra) # 5bd4 <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a4a50513          	addi	a0,a0,-1462 # 5e08 <malloc+0x17c>
  ...
  if(pid == 0){
    ...
    13ec:	a20a0a13          	addi	s4,s4,-1504 # 5e08 <malloc+0x17c>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	248a8a93          	addi	s5,s5,584 # 6638 <malloc+0x9ac>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	1a850513          	addi	a0,a0,424 # 6608 <malloc+0x97c>
    1468:	00004097          	auipc	ra,0x4
    146c:	76c080e7          	jalr	1900(ra) # 5bd4 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	1a450513          	addi	a0,a0,420 # 6620 <malloc+0x994>
    1484:	00004097          	auipc	ra,0x4
    1488:	750080e7          	jalr	1872(ra) # 5bd4 <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	1ae50513          	addi	a0,a0,430 # 6648 <malloc+0x9bc>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	732080e7          	jalr	1842(ra) # 5bd4 <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	950a0a13          	addi	s4,s4,-1712 # 5e08 <malloc+0x17c>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	1a8a8a93          	addi	s5,s5,424 # 6668 <malloc+0x9dc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	8fe50513          	addi	a0,a0,-1794 # 5e08 <malloc+0x17c>
  ...
  exit(xstatus);
    ...
    152c:	0f850513          	addi	a0,a0,248 # 6620 <malloc+0x994>
    1530:	00004097          	auipc	ra,0x4
    1534:	6a4080e7          	jalr	1700(ra) # 5bd4 <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	12a50513          	addi	a0,a0,298 # 6670 <malloc+0x9e4>
    154e:	00004097          	auipc	ra,0x4
    1552:	686080e7          	jalr	1670(ra) # 5bd4 <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	84278793          	addi	a5,a5,-1982 # 5db0 <malloc+0x124>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	11678793          	addi	a5,a5,278 # 6690 <malloc+0xa04>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	10e50513          	addi	a0,a0,270 # 6698 <malloc+0xa0c>
  ...
  if(pid == 0) {
    ...
    15bc:	0e050513          	addi	a0,a0,224 # 6698 <malloc+0xa0c>
    ...
    15d8:	0e450513          	addi	a0,a0,228 # 66b8 <malloc+0xa2c>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	5f8080e7          	jalr	1528(ra) # 5bd4 <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	01850513          	addi	a0,a0,24 # 6608 <malloc+0x97c>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	5dc080e7          	jalr	1500(ra) # 5bd4 <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	09450513          	addi	a0,a0,148 # 66a0 <malloc+0xa14>
    1614:	00004097          	auipc	ra,0x4
    1618:	5c0080e7          	jalr	1472(ra) # 5bd4 <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	78650513          	addi	a0,a0,1926 # 5db0 <malloc+0x124>
  ...
  if(xstatus != 0)
    ...
    1662:	06a50513          	addi	a0,a0,106 # 66c8 <malloc+0xa3c>
    1666:	00004097          	auipc	ra,0x4
    166a:	56e080e7          	jalr	1390(ra) # 5bd4 <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	06650513          	addi	a0,a0,102 # 66e0 <malloc+0xa54>
    1682:	00004097          	auipc	ra,0x4
    1686:	552080e7          	jalr	1362(ra) # 5bd4 <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	00a50513          	addi	a0,a0,10 # 6698 <malloc+0xa0c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	a9850513          	addi	a0,a0,-1384 # 6150 <malloc+0x4c4>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	514080e7          	jalr	1300(ra) # 5bd4 <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f4c50513          	addi	a0,a0,-180 # 6620 <malloc+0x994>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	4f8080e7          	jalr	1272(ra) # 5bd4 <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	faa50513          	addi	a0,a0,-86 # 6698 <malloc+0xa0c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	fe050513          	addi	a0,a0,-32 # 66f8 <malloc+0xa6c>
    1720:	00004097          	auipc	ra,0x4
    1724:	4b4080e7          	jalr	1204(ra) # 5bd4 <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	66ca8a93          	addi	s5,s5,1644 # bdf0 <buf>
      if(cc > sizeof(buf))
    ...
    17a6:	64e70713          	addi	a4,a4,1614 # bdf0 <buf>
    ...
    17dc:	f3850513          	addi	a0,a0,-200 # 6710 <malloc+0xa84>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	3f4080e7          	jalr	1012(ra) # 5bd4 <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	5f2b0b13          	addi	s6,s6,1522 # bdf0 <buf>
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	eca50513          	addi	a0,a0,-310 # 6728 <malloc+0xa9c>
    1866:	00004097          	auipc	ra,0x4
    186a:	36e080e7          	jalr	878(ra) # 5bd4 <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	ec650513          	addi	a0,a0,-314 # 6740 <malloc+0xab4>
    1882:	00004097          	auipc	ra,0x4
    1886:	352080e7          	jalr	850(ra) # 5bd4 <printf>
}
    ...
    18b0:	eac50513          	addi	a0,a0,-340 # 6758 <malloc+0xacc>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	320080e7          	jalr	800(ra) # 5bd4 <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	e8c50513          	addi	a0,a0,-372 # 6778 <malloc+0xaec>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	2e0080e7          	jalr	736(ra) # 5bd4 <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	caa50513          	addi	a0,a0,-854 # 6608 <malloc+0x97c>
    1966:	00004097          	auipc	ra,0x4
    196a:	26e080e7          	jalr	622(ra) # 5bd4 <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e1650513          	addi	a0,a0,-490 # 6790 <malloc+0xb04>
    1982:	00004097          	auipc	ra,0x4
    1986:	252080e7          	jalr	594(ra) # 5bd4 <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e1250513          	addi	a0,a0,-494 # 67a8 <malloc+0xb1c>
    199e:	00004097          	auipc	ra,0x4
    19a2:	236080e7          	jalr	566(ra) # 5bd4 <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	bfa50513          	addi	a0,a0,-1030 # 6608 <malloc+0x97c>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	1be080e7          	jalr	446(ra) # 5bd4 <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	bd650513          	addi	a0,a0,-1066 # 6608 <malloc+0x97c>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	19a080e7          	jalr	410(ra) # 5bd4 <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	d1c50513          	addi	a0,a0,-740 # 67c8 <malloc+0xb3c>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	120080e7          	jalr	288(ra) # 5bd4 <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d84080e7          	jalr	-636(ra) # 5842 <exit>
{
    ...
    1b08:	cd450513          	addi	a0,a0,-812 # 67d8 <malloc+0xb4c>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	0c8080e7          	jalr	200(ra) # 5bd4 <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	ed650513          	addi	a0,a0,-298 # 6a28 <malloc+0xd9c>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	07a080e7          	jalr	122(ra) # 5bd4 <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	e3850513          	addi	a0,a0,-456 # 6a28 <malloc+0xd9c>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	fdc080e7          	jalr	-36(ra) # 5bd4 <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	a8450513          	addi	a0,a0,-1404 # 66a0 <malloc+0xa14>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	fb0080e7          	jalr	-80(ra) # 5bd4 <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	b6a50513          	addi	a0,a0,-1174 # 67f8 <malloc+0xb6c>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f3e080e7          	jalr	-194(ra) # 5bd4 <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b4e50513          	addi	a0,a0,-1202 # 6810 <malloc+0xb84>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	f0a080e7          	jalr	-246(ra) # 5bd4 <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b1050513          	addi	a0,a0,-1264 # 6838 <malloc+0xbac>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	ea4080e7          	jalr	-348(ra) # 5bd4 <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	05850513          	addi	a0,a0,88 # 5e20 <malloc+0x194>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c5606d>
    ...
    1e08:	01ca8a93          	addi	s5,s5,28 # 5e20 <malloc+0x194>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a54b8b93          	addi	s7,s7,-1452 # 6860 <malloc+0xbd4>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00004517          	auipc	a0,0x4
    1e1c:	7f050513          	addi	a0,a0,2032 # 6608 <malloc+0x97c>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	db4080e7          	jalr	-588(ra) # 5bd4 <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	b2250513          	addi	a0,a0,-1246 # 6a28 <malloc+0xd9c>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	cc6080e7          	jalr	-826(ra) # 5bd4 <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	eaeb0b13          	addi	s6,s6,-338 # bdf0 <buf>
    ...
    1fba:	8b250513          	addi	a0,a0,-1870 # 6868 <malloc+0xbdc>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	c16080e7          	jalr	-1002(ra) # 5bd4 <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	eaa50513          	addi	a0,a0,-342 # 5e80 <malloc+0x1f4>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	bf6080e7          	jalr	-1034(ra) # 5bd4 <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	87450513          	addi	a0,a0,-1932 # 6898 <malloc+0xc0c>
    202c:	00004097          	auipc	ra,0x4
    2030:	ba8080e7          	jalr	-1112(ra) # 5bd4 <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	7fa50513          	addi	a0,a0,2042 # 6880 <malloc+0xbf4>
    208e:	00004097          	auipc	ra,0x4
    2092:	b46080e7          	jalr	-1210(ra) # 5bd4 <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	81e50513          	addi	a0,a0,-2018 # 68c0 <malloc+0xc34>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b2a080e7          	jalr	-1238(ra) # 5bd4 <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	81a50513          	addi	a0,a0,-2022 # 68d8 <malloc+0xc4c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	b0e080e7          	jalr	-1266(ra) # 5bd4 <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	addi	s3,s3,848 # c350 <buf+0x560>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	slli	s2,s2,0x3
    20fe:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e680>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	4ca50513          	addi	a0,a0,1226 # 6608 <malloc+0x97c>
    2146:	00004097          	auipc	ra,0x4
    214a:	a8e080e7          	jalr	-1394(ra) # 5bd4 <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	79050513          	addi	a0,a0,1936 # 68f0 <malloc+0xc64>
    2168:	00004097          	auipc	ra,0x4
    216c:	a6c080e7          	jalr	-1428(ra) # 5bd4 <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	42650513          	addi	a0,a0,1062 # 6608 <malloc+0x97c>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	9ea080e7          	jalr	-1558(ra) # 5bd4 <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	70250513          	addi	a0,a0,1794 # 6910 <malloc+0xc84>
    2216:	00004097          	auipc	ra,0x4
    221a:	9be080e7          	jalr	-1602(ra) # 5bd4 <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	6ea50513          	addi	a0,a0,1770 # 6928 <malloc+0xc9c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	6b850513          	addi	a0,a0,1720 # 6928 <malloc+0xc9c>
  ...
  close(fd);
    ...
    229a:	34278793          	addi	a5,a5,834 # 85d8 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	43268693          	addi	a3,a3,1074 # 86d0 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	69270713          	addi	a4,a4,1682 # 6938 <malloc+0xcac>
    ...
    22fe:	71e50513          	addi	a0,a0,1822 # 6a18 <malloc+0xd8c>
    2302:	00004097          	auipc	ra,0x4
    2306:	8d2080e7          	jalr	-1838(ra) # 5bd4 <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	71a50513          	addi	a0,a0,1818 # 6a38 <malloc+0xdac>
    2326:	00004097          	auipc	ra,0x4
    232a:	8ae080e7          	jalr	-1874(ra) # 5bd4 <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0200>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	6dc50513          	addi	a0,a0,1756 # 6a58 <malloc+0xdcc>
    2384:	00004097          	auipc	ra,0x4
    2388:	850080e7          	jalr	-1968(ra) # 5bd4 <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	27050513          	addi	a0,a0,624 # 6608 <malloc+0x97c>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	834080e7          	jalr	-1996(ra) # 5bd4 <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	2ce78793          	addi	a5,a5,718 # 7700 <malloc+0x1a74>
  ...
  if(ret != -1){
    ...
    2478:	60c50513          	addi	a0,a0,1548 # 6a80 <malloc+0xdf4>
    247c:	00003097          	auipc	ra,0x3
    2480:	758080e7          	jalr	1880(ra) # 5bd4 <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	09650513          	addi	a0,a0,150 # 6528 <malloc+0x89c>
    249a:	00003097          	auipc	ra,0x3
    249e:	73a080e7          	jalr	1850(ra) # 5bd4 <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	09850513          	addi	a0,a0,152 # 6548 <malloc+0x8bc>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	71c080e7          	jalr	1820(ra) # 5bd4 <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	09850513          	addi	a0,a0,152 # 6568 <malloc+0x8dc>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	6fc080e7          	jalr	1788(ra) # 5bd4 <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	0a250513          	addi	a0,a0,162 # 6590 <malloc+0x904>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	6de080e7          	jalr	1758(ra) # 5bd4 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	58650513          	addi	a0,a0,1414 # 6ac0 <malloc+0xe34>
  ...
  if(n >= 0){
    ...
    256e:	57650513          	addi	a0,a0,1398 # 6ae0 <malloc+0xe54>
    2572:	00003097          	auipc	ra,0x3
    2576:	662080e7          	jalr	1634(ra) # 5bd4 <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	50450513          	addi	a0,a0,1284 # 6a88 <malloc+0xdfc>
    258c:	00003097          	auipc	ra,0x3
    2590:	648080e7          	jalr	1608(ra) # 5bd4 <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	50250513          	addi	a0,a0,1282 # 6aa0 <malloc+0xe14>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	62e080e7          	jalr	1582(ra) # 5bd4 <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	51050513          	addi	a0,a0,1296 # 6ac8 <malloc+0xe3c>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	614080e7          	jalr	1556(ra) # 5bd4 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	4e450513          	addi	a0,a0,1252 # 6ac0 <malloc+0xe34>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2ae080e7          	jalr	686(ra) # 5892 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	96a50513          	addi	a0,a0,-1686 # 5f58 <malloc+0x2cc>
  ...
  if(n >= 0){
    ...
    261c:	4f850513          	addi	a0,a0,1272 # 6b10 <malloc+0xe84>
    2620:	00003097          	auipc	ra,0x3
    2624:	5b4080e7          	jalr	1460(ra) # 5bd4 <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	49650513          	addi	a0,a0,1174 # 6ac8 <malloc+0xe3c>
    263a:	00003097          	auipc	ra,0x3
    263e:	59a080e7          	jalr	1434(ra) # 5bd4 <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1200>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	48650513          	addi	a0,a0,1158 # 6b38 <malloc+0xeac>
    26ba:	00003097          	auipc	ra,0x3
    26be:	51a080e7          	jalr	1306(ra) # 5bd4 <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	45450513          	addi	a0,a0,1108 # 6b58 <malloc+0xecc>
    270c:	00003097          	auipc	ra,0x3
    2710:	4c8080e7          	jalr	1224(ra) # 5bd4 <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	45050513          	addi	a0,a0,1104 # 6bb8 <malloc+0xf2c>
    2770:	00003097          	auipc	ra,0x3
    2774:	464080e7          	jalr	1124(ra) # 5bd4 <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	3ee50513          	addi	a0,a0,1006 # 6b78 <malloc+0xeec>
    2792:	00003097          	auipc	ra,0x3
    2796:	442080e7          	jalr	1090(ra) # 5bd4 <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	3f250513          	addi	a0,a0,1010 # 6b98 <malloc+0xf0c>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	426080e7          	jalr	1062(ra) # 5bd4 <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11ff>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11ff>
  ...
  if(c != a){
    ...
    28f4:	2e850513          	addi	a0,a0,744 # 6bd8 <malloc+0xf4c>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	2dc080e7          	jalr	732(ra) # 5bd4 <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	31450513          	addi	a0,a0,788 # 6c20 <malloc+0xf94>
    2914:	00003097          	auipc	ra,0x3
    2918:	2c0080e7          	jalr	704(ra) # 5bd4 <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	31450513          	addi	a0,a0,788 # 6c40 <malloc+0xfb4>
    2934:	00003097          	auipc	ra,0x3
    2938:	2a0080e7          	jalr	672(ra) # 5bd4 <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	33450513          	addi	a0,a0,820 # 6c80 <malloc+0xff4>
    2954:	00003097          	auipc	ra,0x3
    2958:	280080e7          	jalr	640(ra) # 5bd4 <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	34850513          	addi	a0,a0,840 # 6cb0 <malloc+0x1024>
    2970:	00003097          	auipc	ra,0x3
    2974:	264080e7          	jalr	612(ra) # 5bd4 <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	36050513          	addi	a0,a0,864 # 6ce8 <malloc+0x105c>
    2990:	00003097          	auipc	ra,0x3
    2994:	244080e7          	jalr	580(ra) # 5bd4 <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	34e50513          	addi	a0,a0,846 # 6d10 <malloc+0x1084>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	eb8080e7          	jalr	-328(ra) # 5882 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	33c50513          	addi	a0,a0,828 # 6d10 <malloc+0x1084>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	2f050513          	addi	a0,a0,752 # 6d18 <malloc+0x108c>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	1a4080e7          	jalr	420(ra) # 5bd4 <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	2ec50513          	addi	a0,a0,748 # 6d30 <malloc+0x10a4>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	188080e7          	jalr	392(ra) # 5bd4 <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	cb050513          	addi	a0,a0,-848 # 6710 <malloc+0xa84>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	16c080e7          	jalr	364(ra) # 5bd4 <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	2be50513          	addi	a0,a0,702 # 6d48 <malloc+0x10bc>
  ...
  close(fd);
    ...
    2ad6:	b4e50513          	addi	a0,a0,-1202 # 6620 <malloc+0x994>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	0fa080e7          	jalr	250(ra) # 5bd4 <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	f0850513          	addi	a0,a0,-248 # 6a28 <malloc+0xd9c>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	0ac080e7          	jalr	172(ra) # 5bd4 <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	eb250513          	addi	a0,a0,-334 # 6a28 <malloc+0xd9c>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	056080e7          	jalr	86(ra) # 5bd4 <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x1120>
    ...
    2bda:	e5250513          	addi	a0,a0,-430 # 6a28 <malloc+0xd9c>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	ff6080e7          	jalr	-10(ra) # 5bd4 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1204>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	cde50513          	addi	a0,a0,-802 # 6a28 <malloc+0xd9c>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	e82080e7          	jalr	-382(ra) # 5bd4 <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	01250513          	addi	a0,a0,18 # 5db0 <malloc+0x124>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	07678793          	addi	a5,a5,118 # 5e20 <malloc+0x194>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	14450513          	addi	a0,a0,324 # 6f20 <malloc+0x1294>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	f8a50513          	addi	a0,a0,-118 # 6d78 <malloc+0x10ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	fcc50513          	addi	a0,a0,-52 # 6dd0 <malloc+0x1144>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	02650513          	addi	a0,a0,38 # 6e48 <malloc+0x11bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	07a50513          	addi	a0,a0,122 # 6eb8 <malloc+0x122c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	0c050513          	addi	a0,a0,192 # 6f10 <malloc+0x1284>
  ...
  unlink("12345678901234");
    ...
    2ed2:	e8250513          	addi	a0,a0,-382 # 6d50 <malloc+0x10c4>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	cfe080e7          	jalr	-770(ra) # 5bd4 <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	eae50513          	addi	a0,a0,-338 # 6d98 <malloc+0x110c>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	ce2080e7          	jalr	-798(ra) # 5bd4 <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	efa50513          	addi	a0,a0,-262 # 6e00 <malloc+0x1174>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	cc6080e7          	jalr	-826(ra) # 5bd4 <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f5650513          	addi	a0,a0,-170 # 6e78 <malloc+0x11ec>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	caa080e7          	jalr	-854(ra) # 5bd4 <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	f9a50513          	addi	a0,a0,-102 # 6ed8 <malloc+0x124c>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	c8e080e7          	jalr	-882(ra) # 5bd4 <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	fd650513          	addi	a0,a0,-42 # 6f30 <malloc+0x12a4>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c72080e7          	jalr	-910(ra) # 5bd4 <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	fe850513          	addi	a0,a0,-24 # 6f68 <malloc+0x12dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	fd450513          	addi	a0,a0,-44 # 6f68 <malloc+0x12dc>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	01c50513          	addi	a0,a0,28 # 6fd8 <malloc+0x134c>
    ...
    2fe0:	f9450513          	addi	a0,a0,-108 # 6f70 <malloc+0x12e4>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	bf0080e7          	jalr	-1040(ra) # 5bd4 <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	f9050513          	addi	a0,a0,-112 # 6f88 <malloc+0x12fc>
    3000:	00003097          	auipc	ra,0x3
    3004:	bd4080e7          	jalr	-1068(ra) # 5bd4 <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	fa450513          	addi	a0,a0,-92 # 6fb8 <malloc+0x132c>
    301c:	00003097          	auipc	ra,0x3
    3020:	bb8080e7          	jalr	-1096(ra) # 5bd4 <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	fb050513          	addi	a0,a0,-80 # 6fe0 <malloc+0x1354>
    3038:	00003097          	auipc	ra,0x3
    303c:	b9c080e7          	jalr	-1124(ra) # 5bd4 <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	f0450513          	addi	a0,a0,-252 # 6f68 <malloc+0x12dc>
    ...
    307c:	ef050513          	addi	a0,a0,-272 # 6f68 <malloc+0x12dc>
    ...
    3090:	f1c50513          	addi	a0,a0,-228 # 6fa8 <malloc+0x131c>
    ...
    30b0:	55c50513          	addi	a0,a0,1372 # 6608 <malloc+0x97c>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	b20080e7          	jalr	-1248(ra) # 5bd4 <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	ea850513          	addi	a0,a0,-344 # 6f70 <malloc+0x12e4>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	b04080e7          	jalr	-1276(ra) # 5bd4 <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f1450513          	addi	a0,a0,-236 # 6ff8 <malloc+0x136c>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	ae8080e7          	jalr	-1304(ra) # 5bd4 <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	eb850513          	addi	a0,a0,-328 # 6fb8 <malloc+0x132c>
    3108:	00003097          	auipc	ra,0x3
    310c:	acc080e7          	jalr	-1332(ra) # 5bd4 <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	ed250513          	addi	a0,a0,-302 # 7010 <malloc+0x1384>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	ebe50513          	addi	a0,a0,-322 # 7010 <malloc+0x1384>
  ...
  if(chdir("..") < 0){
    ...
    316a:	eca50513          	addi	a0,a0,-310 # 7030 <malloc+0x13a4>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	e9650513          	addi	a0,a0,-362 # 7010 <malloc+0x1384>
    ...
    319e:	dd650513          	addi	a0,a0,-554 # 6f70 <malloc+0x12e4>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a32080e7          	jalr	-1486(ra) # 5bd4 <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e6250513          	addi	a0,a0,-414 # 7018 <malloc+0x138c>
    31be:	00003097          	auipc	ra,0x3
    31c2:	a16080e7          	jalr	-1514(ra) # 5bd4 <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e6650513          	addi	a0,a0,-410 # 7038 <malloc+0x13ac>
    31da:	00003097          	auipc	ra,0x3
    31de:	9fa080e7          	jalr	-1542(ra) # 5bd4 <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e6250513          	addi	a0,a0,-414 # 7050 <malloc+0x13c4>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	9de080e7          	jalr	-1570(ra) # 5bd4 <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	f8250513          	addi	a0,a0,-126 # 7198 <malloc+0x150c>
    321e:	00002097          	auipc	ra,0x2
    3222:	674080e7          	jalr	1652(ra) # 5892 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e4250513          	addi	a0,a0,-446 # 7068 <malloc+0x13dc>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e4a50513          	addi	a0,a0,-438 # 7088 <malloc+0x13fc>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f4258593          	addi	a1,a1,-190 # 7198 <malloc+0x150c>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	df850513          	addi	a0,a0,-520 # 7068 <malloc+0x13dc>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e5c50513          	addi	a0,a0,-420 # 70e0 <malloc+0x1454>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e6c50513          	addi	a0,a0,-404 # 7108 <malloc+0x147c>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	e8458593          	addi	a1,a1,-380 # 7138 <malloc+0x14ac>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e7050513          	addi	a0,a0,-400 # 7140 <malloc+0x14b4>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	b0858593          	addi	a1,a1,-1272 # bdf0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	af274703          	lbu	a4,-1294(a4) # bdf0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	e7858593          	addi	a1,a1,-392 # 7190 <malloc+0x1504>
    3320:	00004517          	auipc	a0,0x4
    3324:	de850513          	addi	a0,a0,-536 # 7108 <malloc+0x147c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	dd450513          	addi	a0,a0,-556 # 7108 <malloc+0x147c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	dbe50513          	addi	a0,a0,-578 # 7108 <malloc+0x147c>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	d0a50513          	addi	a0,a0,-758 # 7068 <malloc+0x13dc>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	eb650513          	addi	a0,a0,-330 # 7228 <malloc+0x159c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	ed250513          	addi	a0,a0,-302 # 7258 <malloc+0x15cc>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	eee50513          	addi	a0,a0,-274 # 7288 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	de050513          	addi	a0,a0,-544 # 7190 <malloc+0x1504>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	a2858593          	addi	a1,a1,-1496 # bdf0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	d1e50513          	addi	a0,a0,-738 # 7108 <malloc+0x147c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f1650513          	addi	a0,a0,-234 # 7318 <malloc+0x168c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	f2e50513          	addi	a0,a0,-210 # 7348 <malloc+0x16bc>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c3650513          	addi	a0,a0,-970 # 7068 <malloc+0x13dc>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	c2050513          	addi	a0,a0,-992 # 7068 <malloc+0x13dc>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	c0a50513          	addi	a0,a0,-1014 # 7068 <malloc+0x13dc>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f6658593          	addi	a1,a1,-154 # 73d8 <malloc+0x174c>
    347a:	00004517          	auipc	a0,0x4
    347e:	e9e50513          	addi	a0,a0,-354 # 7318 <malloc+0x168c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f4a58593          	addi	a1,a1,-182 # 73d8 <malloc+0x174c>
    3496:	00004517          	auipc	a0,0x4
    349a:	eb250513          	addi	a0,a0,-334 # 7348 <malloc+0x16bc>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	ce658593          	addi	a1,a1,-794 # 7190 <malloc+0x1504>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	bd650513          	addi	a0,a0,-1066 # 7088 <malloc+0x13fc>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e5250513          	addi	a0,a0,-430 # 7318 <malloc+0x168c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e6e50513          	addi	a0,a0,-402 # 7348 <malloc+0x16bc>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	ca250513          	addi	a0,a0,-862 # 7190 <malloc+0x1504>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e4650513          	addi	a0,a0,-442 # 7348 <malloc+0x16bc>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	e0250513          	addi	a0,a0,-510 # 7318 <malloc+0x168c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b5e50513          	addi	a0,a0,-1186 # 7088 <malloc+0x13fc>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	fea50513          	addi	a0,a0,-22 # 7528 <malloc+0x189c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	c3e50513          	addi	a0,a0,-962 # 7190 <malloc+0x1504>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	b2250513          	addi	a0,a0,-1246 # 7088 <malloc+0x13fc>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	aee50513          	addi	a0,a0,-1298 # 7068 <malloc+0x13dc>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	00a50513          	addi	a0,a0,10 # 7598 <malloc+0x190c>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	ac650513          	addi	a0,a0,-1338 # 7068 <malloc+0x13dc>
    ...
    35c8:	aac50513          	addi	a0,a0,-1364 # 7070 <malloc+0x13e4>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	608080e7          	jalr	1544(ra) # 5bd4 <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	ab050513          	addi	a0,a0,-1360 # 7090 <malloc+0x1404>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	5ec080e7          	jalr	1516(ra) # 5bd4 <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	ab450513          	addi	a0,a0,-1356 # 70b0 <malloc+0x1424>
    3604:	00002097          	auipc	ra,0x2
    3608:	5d0080e7          	jalr	1488(ra) # 5bd4 <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	ad050513          	addi	a0,a0,-1328 # 70e8 <malloc+0x145c>
    3620:	00002097          	auipc	ra,0x2
    3624:	5b4080e7          	jalr	1460(ra) # 5bd4 <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	ae450513          	addi	a0,a0,-1308 # 7118 <malloc+0x148c>
    363c:	00002097          	auipc	ra,0x2
    3640:	598080e7          	jalr	1432(ra) # 5bd4 <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	b0050513          	addi	a0,a0,-1280 # 7150 <malloc+0x14c4>
    3658:	00002097          	auipc	ra,0x2
    365c:	57c080e7          	jalr	1404(ra) # 5bd4 <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	b0450513          	addi	a0,a0,-1276 # 7170 <malloc+0x14e4>
    3674:	00002097          	auipc	ra,0x2
    3678:	560080e7          	jalr	1376(ra) # 5bd4 <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	b1850513          	addi	a0,a0,-1256 # 71a0 <malloc+0x1514>
    3690:	00002097          	auipc	ra,0x2
    3694:	544080e7          	jalr	1348(ra) # 5bd4 <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	b2450513          	addi	a0,a0,-1244 # 71c8 <malloc+0x153c>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	528080e7          	jalr	1320(ra) # 5bd4 <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	b2850513          	addi	a0,a0,-1240 # 71e8 <malloc+0x155c>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	50c080e7          	jalr	1292(ra) # 5bd4 <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b3450513          	addi	a0,a0,-1228 # 7210 <malloc+0x1584>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	4f0080e7          	jalr	1264(ra) # 5bd4 <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b4050513          	addi	a0,a0,-1216 # 7238 <malloc+0x15ac>
    3700:	00002097          	auipc	ra,0x2
    3704:	4d4080e7          	jalr	1236(ra) # 5bd4 <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b5450513          	addi	a0,a0,-1196 # 7268 <malloc+0x15dc>
    371c:	00002097          	auipc	ra,0x2
    3720:	4b8080e7          	jalr	1208(ra) # 5bd4 <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b6050513          	addi	a0,a0,-1184 # 7290 <malloc+0x1604>
    3738:	00002097          	auipc	ra,0x2
    373c:	49c080e7          	jalr	1180(ra) # 5bd4 <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b5c50513          	addi	a0,a0,-1188 # 72a8 <malloc+0x161c>
    3754:	00002097          	auipc	ra,0x2
    3758:	480080e7          	jalr	1152(ra) # 5bd4 <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b6050513          	addi	a0,a0,-1184 # 72c8 <malloc+0x163c>
    3770:	00002097          	auipc	ra,0x2
    3774:	464080e7          	jalr	1124(ra) # 5bd4 <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b6450513          	addi	a0,a0,-1180 # 72e8 <malloc+0x165c>
    378c:	00002097          	auipc	ra,0x2
    3790:	448080e7          	jalr	1096(ra) # 5bd4 <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	b8850513          	addi	a0,a0,-1144 # 7328 <malloc+0x169c>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	42c080e7          	jalr	1068(ra) # 5bd4 <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	b9c50513          	addi	a0,a0,-1124 # 7358 <malloc+0x16cc>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	410080e7          	jalr	1040(ra) # 5bd4 <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	ba050513          	addi	a0,a0,-1120 # 7378 <malloc+0x16ec>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	3f4080e7          	jalr	1012(ra) # 5bd4 <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	ba450513          	addi	a0,a0,-1116 # 7398 <malloc+0x170c>
    37fc:	00002097          	auipc	ra,0x2
    3800:	3d8080e7          	jalr	984(ra) # 5bd4 <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	ba850513          	addi	a0,a0,-1112 # 73b8 <malloc+0x172c>
    3818:	00002097          	auipc	ra,0x2
    381c:	3bc080e7          	jalr	956(ra) # 5bd4 <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	bbc50513          	addi	a0,a0,-1092 # 73e8 <malloc+0x175c>
    3834:	00002097          	auipc	ra,0x2
    3838:	3a0080e7          	jalr	928(ra) # 5bd4 <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	bc850513          	addi	a0,a0,-1080 # 7410 <malloc+0x1784>
    3850:	00002097          	auipc	ra,0x2
    3854:	384080e7          	jalr	900(ra) # 5bd4 <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	bd450513          	addi	a0,a0,-1068 # 7438 <malloc+0x17ac>
    386c:	00002097          	auipc	ra,0x2
    3870:	368080e7          	jalr	872(ra) # 5bd4 <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	be050513          	addi	a0,a0,-1056 # 7460 <malloc+0x17d4>
    3888:	00002097          	auipc	ra,0x2
    388c:	34c080e7          	jalr	844(ra) # 5bd4 <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	be450513          	addi	a0,a0,-1052 # 7480 <malloc+0x17f4>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	330080e7          	jalr	816(ra) # 5bd4 <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	be850513          	addi	a0,a0,-1048 # 74a0 <malloc+0x1814>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	314080e7          	jalr	788(ra) # 5bd4 <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	bf450513          	addi	a0,a0,-1036 # 74c8 <malloc+0x183c>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	2f8080e7          	jalr	760(ra) # 5bd4 <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	bf850513          	addi	a0,a0,-1032 # 74e8 <malloc+0x185c>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	2dc080e7          	jalr	732(ra) # 5bd4 <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	bfc50513          	addi	a0,a0,-1028 # 7508 <malloc+0x187c>
    3914:	00002097          	auipc	ra,0x2
    3918:	2c0080e7          	jalr	704(ra) # 5bd4 <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	c0850513          	addi	a0,a0,-1016 # 7530 <malloc+0x18a4>
    3930:	00002097          	auipc	ra,0x2
    3934:	2a4080e7          	jalr	676(ra) # 5bd4 <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	88450513          	addi	a0,a0,-1916 # 71c8 <malloc+0x153c>
    394c:	00002097          	auipc	ra,0x2
    3950:	288080e7          	jalr	648(ra) # 5bd4 <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	bf050513          	addi	a0,a0,-1040 # 7550 <malloc+0x18c4>
    3968:	00002097          	auipc	ra,0x2
    396c:	26c080e7          	jalr	620(ra) # 5bd4 <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	bf450513          	addi	a0,a0,-1036 # 7570 <malloc+0x18e4>
    3984:	00002097          	auipc	ra,0x2
    3988:	250080e7          	jalr	592(ra) # 5bd4 <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	c0850513          	addi	a0,a0,-1016 # 75a0 <malloc+0x1914>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	234080e7          	jalr	564(ra) # 5bd4 <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	c0c50513          	addi	a0,a0,-1012 # 75c0 <malloc+0x1934>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	218080e7          	jalr	536(ra) # 5bd4 <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	bfe50513          	addi	a0,a0,-1026 # 75d8 <malloc+0x194c>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	bec50513          	addi	a0,a0,-1044 # 75d8 <malloc+0x194c>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a6a50513          	addi	a0,a0,-1430 # 6468 <malloc+0x7dc>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	62050513          	addi	a0,a0,1568 # 7030 <malloc+0x13a4>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	5b650513          	addi	a0,a0,1462 # 6fd8 <malloc+0x134c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	c0c50513          	addi	a0,a0,-1012 # 7640 <malloc+0x19b4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	c2250513          	addi	a0,a0,-990 # 7668 <malloc+0x19dc>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	b8050513          	addi	a0,a0,-1152 # 75d8 <malloc+0x194c>
    ...
    3a7a:	b6a50513          	addi	a0,a0,-1174 # 75e0 <malloc+0x1954>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	156080e7          	jalr	342(ra) # 5bd4 <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b6650513          	addi	a0,a0,-1178 # 75f8 <malloc+0x196c>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	13a080e7          	jalr	314(ra) # 5bd4 <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b6250513          	addi	a0,a0,-1182 # 7610 <malloc+0x1984>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	11e080e7          	jalr	286(ra) # 5bd4 <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b5e50513          	addi	a0,a0,-1186 # 7628 <malloc+0x199c>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	102080e7          	jalr	258(ra) # 5bd4 <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	4fa50513          	addi	a0,a0,1274 # 6fe0 <malloc+0x1354>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	0e6080e7          	jalr	230(ra) # 5bd4 <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b4650513          	addi	a0,a0,-1210 # 7648 <malloc+0x19bc>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0ca080e7          	jalr	202(ra) # 5bd4 <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b5250513          	addi	a0,a0,-1198 # 7670 <malloc+0x19e4>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	0ae080e7          	jalr	174(ra) # 5bd4 <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b5650513          	addi	a0,a0,-1194 # 7690 <malloc+0x1a04>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	092080e7          	jalr	146(ra) # 5bd4 <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b4a50513          	addi	a0,a0,-1206 # 76b0 <malloc+0x1a24>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	b2e50513          	addi	a0,a0,-1234 # 76b0 <malloc+0x1a24>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b6250513          	addi	a0,a0,-1182 # 76f8 <malloc+0x1a6c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b4a50513          	addi	a0,a0,-1206 # 76f8 <malloc+0x1a6c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b3650513          	addi	a0,a0,-1226 # 76f8 <malloc+0x1a6c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	b2250513          	addi	a0,a0,-1246 # 76f8 <malloc+0x1a6c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	b0e58593          	addi	a1,a1,-1266 # 76f8 <malloc+0x1a6c>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	36650513          	addi	a0,a0,870 # 5f58 <malloc+0x2cc>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	aaa50513          	addi	a0,a0,-1366 # 76b0 <malloc+0x1a24>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	84c50513          	addi	a0,a0,-1972 # 6468 <malloc+0x7dc>
  ...
  fd = open(".", 0);
    ...
    3c36:	83650513          	addi	a0,a0,-1994 # 6468 <malloc+0x7dc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	1da58593          	addi	a1,a1,474 # 5e20 <malloc+0x194>
  ...
  close(fd);
    ...
    3c76:	a4650513          	addi	a0,a0,-1466 # 76b8 <malloc+0x1a2c>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f5a080e7          	jalr	-166(ra) # 5bd4 <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a4a50513          	addi	a0,a0,-1462 # 76d8 <malloc+0x1a4c>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f3e080e7          	jalr	-194(ra) # 5bd4 <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a5e50513          	addi	a0,a0,-1442 # 7708 <malloc+0x1a7c>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	f22080e7          	jalr	-222(ra) # 5bd4 <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a4250513          	addi	a0,a0,-1470 # 7708 <malloc+0x1a7c>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	f06080e7          	jalr	-250(ra) # 5bd4 <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a4e50513          	addi	a0,a0,-1458 # 7730 <malloc+0x1aa4>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	eea080e7          	jalr	-278(ra) # 5bd4 <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a5a50513          	addi	a0,a0,-1446 # 7758 <malloc+0x1acc>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	ece080e7          	jalr	-306(ra) # 5bd4 <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a6650513          	addi	a0,a0,-1434 # 7780 <malloc+0x1af4>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	eb2080e7          	jalr	-334(ra) # 5bd4 <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	a7250513          	addi	a0,a0,-1422 # 77a8 <malloc+0x1b1c>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	e96080e7          	jalr	-362(ra) # 5bd4 <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	a7650513          	addi	a0,a0,-1418 # 77c8 <malloc+0x1b3c>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	e7a080e7          	jalr	-390(ra) # 5bd4 <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	a8250513          	addi	a0,a0,-1406 # 77f0 <malloc+0x1b64>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e5e080e7          	jalr	-418(ra) # 5bd4 <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a66a0a13          	addi	s4,s4,-1434 # 7808 <malloc+0x1b7c>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	56648493          	addi	s1,s1,1382 # 7310 <malloc+0x1684>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	1a6a8a93          	addi	s5,s5,422 # 5f58 <malloc+0x2cc>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	94698993          	addi	s3,s3,-1722 # 7700 <malloc+0x1a74>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a4a50513          	addi	a0,a0,-1462 # 7810 <malloc+0x1b84>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	e06080e7          	jalr	-506(ra) # 5bd4 <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a4650513          	addi	a0,a0,-1466 # 7828 <malloc+0x1b9c>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	dea080e7          	jalr	-534(ra) # 5bd4 <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	1ba98993          	addi	s3,s3,442 # 7030 <malloc+0x13a4>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	98a90913          	addi	s2,s2,-1654 # 7808 <malloc+0x1b7c>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	13a50513          	addi	a0,a0,314 # 6fd8 <malloc+0x134c>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	97250513          	addi	a0,a0,-1678 # 7840 <malloc+0x1bb4>
  ...
  if(pid == 0){
    ...
    3ef6:	94e50513          	addi	a0,a0,-1714 # 7840 <malloc+0x1bb4>
    ...
    3f0c:	95850513          	addi	a0,a0,-1704 # 7860 <malloc+0x1bd4>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	cc4080e7          	jalr	-828(ra) # 5bd4 <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	92450513          	addi	a0,a0,-1756 # 7848 <malloc+0x1bbc>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	ca8080e7          	jalr	-856(ra) # 5bd4 <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	6c850513          	addi	a0,a0,1736 # 6608 <malloc+0x97c>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	c8c080e7          	jalr	-884(ra) # 5bd4 <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	8d250513          	addi	a0,a0,-1838 # 7840 <malloc+0x1bb4>
    ...
    3f86:	87650513          	addi	a0,a0,-1930 # 67f8 <malloc+0xb6c>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c4a080e7          	jalr	-950(ra) # 5bd4 <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	8c850513          	addi	a0,a0,-1848 # 7888 <malloc+0x1bfc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	89c50513          	addi	a0,a0,-1892 # 7888 <malloc+0x1bfc>
  ...
  sleep(10); // one second
    ...
    4028:	7a450513          	addi	a0,a0,1956 # 67c8 <malloc+0xb3c>
    402c:	00002097          	auipc	ra,0x2
    4030:	ba8080e7          	jalr	-1112(ra) # 5bd4 <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	84a48493          	addi	s1,s1,-1974 # 7888 <malloc+0x1bfc>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	52250513          	addi	a0,a0,1314 # 6608 <malloc+0x97c>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	ae6080e7          	jalr	-1306(ra) # 5bd4 <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	78c50513          	addi	a0,a0,1932 # 7898 <malloc+0x1c0c>
    4114:	00002097          	auipc	ra,0x2
    4118:	ac0080e7          	jalr	-1344(ra) # 5bd4 <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	67c50513          	addi	a0,a0,1660 # 67c8 <malloc+0xb3c>
    4154:	00002097          	auipc	ra,0x2
    4158:	a80080e7          	jalr	-1408(ra) # 5bd4 <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	48e50513          	addi	a0,a0,1166 # 6608 <malloc+0x97c>
    4182:	00002097          	auipc	ra,0x2
    4186:	a52080e7          	jalr	-1454(ra) # 5bd4 <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	c6258593          	addi	a1,a1,-926 # 5e20 <malloc+0x194>
    ...
    41ec:	42050513          	addi	a0,a0,1056 # 6608 <malloc+0x97c>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	9e4080e7          	jalr	-1564(ra) # 5bd4 <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	6b450513          	addi	a0,a0,1716 # 78b8 <malloc+0x1c2c>
    420c:	00002097          	auipc	ra,0x2
    4210:	9c8080e7          	jalr	-1592(ra) # 5bd4 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4228:	bcc58593          	addi	a1,a1,-1076 # bdf0 <buf>
    ...
    4244:	69050513          	addi	a0,a0,1680 # 78d0 <malloc+0x1c44>
    4248:	00002097          	auipc	ra,0x2
    424c:	98c080e7          	jalr	-1652(ra) # 5bd4 <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	67c50513          	addi	a0,a0,1660 # 78e8 <malloc+0x1c5c>
    4274:	00002097          	auipc	ra,0x2
    4278:	960080e7          	jalr	-1696(ra) # 5bd4 <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	65e50513          	addi	a0,a0,1630 # 78f8 <malloc+0x1c6c>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	932080e7          	jalr	-1742(ra) # 5bd4 <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	2ee50513          	addi	a0,a0,750 # 6608 <malloc+0x97c>
    4322:	00002097          	auipc	ra,0x2
    4326:	8b2080e7          	jalr	-1870(ra) # 5bd4 <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	45a50513          	addi	a0,a0,1114 # 6790 <malloc+0xb04>
    433e:	00002097          	auipc	ra,0x2
    4342:	896080e7          	jalr	-1898(ra) # 5bd4 <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	36450513          	addi	a0,a0,868 # 6710 <malloc+0xa84>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	820080e7          	jalr	-2016(ra) # 5bd4 <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	a4058593          	addi	a1,a1,-1472 # 5e20 <malloc+0x194>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	46450513          	addi	a0,a0,1124 # 7908 <malloc+0x1c7c>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	728080e7          	jalr	1832(ra) # 5bd4 <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	14850513          	addi	a0,a0,328 # 6608 <malloc+0x97c>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	70c080e7          	jalr	1804(ra) # 5bd4 <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    44fa:	6705                	lui	a4,0x1
      n += *(a+i);
    44fc:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1200>
    ...
    4510:	41c50513          	addi	a0,a0,1052 # 7928 <malloc+0x1c9c>
    4514:	00001097          	auipc	ra,0x1
    4518:	6c0080e7          	jalr	1728(ra) # 5bd4 <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	716080e7          	jalr	1814(ra) # 5c8c <malloc>
    ...
    45b4:	3a850513          	addi	a0,a0,936 # 7958 <malloc+0x1ccc>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	61c080e7          	jalr	1564(ra) # 5bd4 <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	32250513          	addi	a0,a0,802 # 7988 <malloc+0x1cfc>
    466e:	00001097          	auipc	ra,0x1
    4672:	566080e7          	jalr	1382(ra) # 5bd4 <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	32e50513          	addi	a0,a0,814 # 79b0 <malloc+0x1d24>
    468a:	00001097          	auipc	ra,0x1
    468e:	54a080e7          	jalr	1354(ra) # 5bd4 <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	2b250513          	addi	a0,a0,690 # 7978 <malloc+0x1cec>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	2ca50513          	addi	a0,a0,714 # 79d0 <malloc+0x1d44>
    470e:	00001097          	auipc	ra,0x1
    4712:	4c6080e7          	jalr	1222(ra) # 5bd4 <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	23650513          	addi	a0,a0,566 # 7978 <malloc+0x1cec>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	29050513          	addi	a0,a0,656 # 79f8 <malloc+0x1d6c>
    4770:	00001097          	auipc	ra,0x1
    4774:	464080e7          	jalr	1124(ra) # 5bd4 <printf>
    exit(1);
    4778:	4505                	li	a0,1
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	26278793          	addi	a5,a5,610 # 7a10 <malloc+0x1d84>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	25e78793          	addi	a5,a5,606 # 7a18 <malloc+0x1d8c>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	25a78793          	addi	a5,a5,602 # 7a20 <malloc+0x1d94>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	25678793          	addi	a5,a5,598 # 7a28 <malloc+0x1d9c>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    482e:	5c6a0a13          	addi	s4,s4,1478 # bdf0 <buf>
    4832:	00007a97          	auipc	s5,0x7
    4836:	5bfa8a93          	addi	s5,s5,1471 # bdf1 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	1de50513          	addi	a0,a0,478 # 6a28 <malloc+0xd9c>
    4852:	00001097          	auipc	ra,0x1
    4856:	382080e7          	jalr	898(ra) # 5bd4 <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	16a50513          	addi	a0,a0,362 # 7a30 <malloc+0x1da4>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	306080e7          	jalr	774(ra) # 5bd4 <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	16050513          	addi	a0,a0,352 # 7a40 <malloc+0x1db4>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	2ec080e7          	jalr	748(ra) # 5bd4 <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	15050513          	addi	a0,a0,336 # 7a58 <malloc+0x1dcc>
    4910:	00001097          	auipc	ra,0x1
    4914:	2c4080e7          	jalr	708(ra) # 5bd4 <printf>
          exit(1);
    4918:	4505                	li	a0,1
    ...
    493c:	4b878793          	addi	a5,a5,1208 # bdf0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	0d250513          	addi	a0,a0,210 # 7a68 <malloc+0x1ddc>
    499e:	00001097          	auipc	ra,0x1
    49a2:	236080e7          	jalr	566(ra) # 5bd4 <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	088b8b93          	addi	s7,s7,136 # 7a80 <malloc+0x1df4>
  for(i = 0; i < N; i++){
    ...
    4a3e:	04e50513          	addi	a0,a0,78 # 7a88 <malloc+0x1dfc>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	192080e7          	jalr	402(ra) # 5bd4 <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	02850513          	addi	a0,a0,40 # 7a80 <malloc+0x1df4>
  ...
  fd = open(".", 0);
    ...
    4a94:	9d850513          	addi	a0,a0,-1576 # 6468 <malloc+0x7dc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	fa050513          	addi	a0,a0,-96 # 7aa8 <malloc+0x1e1c>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	0c4080e7          	jalr	196(ra) # 5bd4 <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	fa050513          	addi	a0,a0,-96 # 7ac8 <malloc+0x1e3c>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	0a4080e7          	jalr	164(ra) # 5bd4 <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	f9050513          	addi	a0,a0,-112 # 7af0 <malloc+0x1e64>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	06c080e7          	jalr	108(ra) # 5bd4 <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	a8c50513          	addi	a0,a0,-1396 # 6608 <malloc+0x97c>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	050080e7          	jalr	80(ra) # 5bd4 <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6a:	08a90913          	addi	s2,s2,138 # bdf0 <buf>
  for(i = 0; i < N; i++){
    4d6e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	d7a50513          	addi	a0,a0,-646 # 7b28 <malloc+0x1e9c>
  ...
  for(i = 0; ; i++){
    ...
    4dc8:	02c90913          	addi	s2,s2,44 # bdf0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e16:	d2650513          	addi	a0,a0,-730 # 7b38 <malloc+0x1eac>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	dba080e7          	jalr	-582(ra) # 5bd4 <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	d2a50513          	addi	a0,a0,-726 # 7b58 <malloc+0x1ecc>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	d9e080e7          	jalr	-610(ra) # 5bd4 <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	d2e50513          	addi	a0,a0,-722 # 7b78 <malloc+0x1eec>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	d82080e7          	jalr	-638(ra) # 5bd4 <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	d3250513          	addi	a0,a0,-718 # 7b98 <malloc+0x1f0c>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	d66080e7          	jalr	-666(ra) # 5bd4 <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	d3650513          	addi	a0,a0,-714 # 7bb8 <malloc+0x1f2c>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	d4a080e7          	jalr	-694(ra) # 5bd4 <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	d3250513          	addi	a0,a0,-718 # 7bd0 <malloc+0x1f44>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	d2e080e7          	jalr	-722(ra) # 5bd4 <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	c5c50513          	addi	a0,a0,-932 # 7b28 <malloc+0x1e9c>
    ...
    4ef4:	d0050513          	addi	a0,a0,-768 # 7bf0 <malloc+0x1f64>
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	cdc080e7          	jalr	-804(ra) # 5bd4 <printf>
    exit(1);
    4f00:	4505                	li	a0,1
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	ce850513          	addi	a0,a0,-792 # 7c10 <malloc+0x1f84>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	ca4080e7          	jalr	-860(ra) # 5bd4 <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	cd8c8c93          	addi	s9,s9,-808 # 7c20 <malloc+0x1f94>
    int total = 0;
    4f50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f52:	00007a17          	auipc	s4,0x7
    4f56:	e9ea0a13          	addi	s4,s4,-354 # bdf0 <buf>
    name[0] = 'f';
    ...
    4fa4:	c34080e7          	jalr	-972(ra) # 5bd4 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	c6e50513          	addi	a0,a0,-914 # 7c30 <malloc+0x1fa4>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	c0a080e7          	jalr	-1014(ra) # 5bd4 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	c1850513          	addi	a0,a0,-1000 # 7c50 <malloc+0x1fc4>
    5040:	00001097          	auipc	ra,0x1
    5044:	b94080e7          	jalr	-1132(ra) # 5bd4 <printf>
}
    ...
    508c:	bb850513          	addi	a0,a0,-1096 # 7c40 <malloc+0x1fb4>
    5090:	00001097          	auipc	ra,0x1
    5094:	b44080e7          	jalr	-1212(ra) # 5bd4 <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	b4e50513          	addi	a0,a0,-1202 # 7c68 <malloc+0x1fdc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	cee58593          	addi	a1,a1,-786 # 5e20 <malloc+0x194>
    ...
    514c:	b4050513          	addi	a0,a0,-1216 # 7c88 <malloc+0x1ffc>
    5150:	00001097          	auipc	ra,0x1
    5154:	a84080e7          	jalr	-1404(ra) # 5bd4 <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	b0e50513          	addi	a0,a0,-1266 # 7c70 <malloc+0x1fe4>
    516a:	00001097          	auipc	ra,0x1
    516e:	a6a080e7          	jalr	-1430(ra) # 5bd4 <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	af450513          	addi	a0,a0,-1292 # 7c70 <malloc+0x1fe4>
    5184:	00001097          	auipc	ra,0x1
    5188:	a50080e7          	jalr	-1456(ra) # 5bd4 <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	ac850513          	addi	a0,a0,-1336 # 7c68 <malloc+0x1fdc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	c2a98993          	addi	s3,s3,-982 # 5e20 <malloc+0x194>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	ab050513          	addi	a0,a0,-1360 # 7cd8 <malloc+0x204c>
    5230:	00001097          	auipc	ra,0x1
    5234:	9a4080e7          	jalr	-1628(ra) # 5bd4 <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	a5650513          	addi	a0,a0,-1450 # 7c98 <malloc+0x200c>
    524a:	00001097          	auipc	ra,0x1
    524e:	98a080e7          	jalr	-1654(ra) # 5bd4 <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	a5c50513          	addi	a0,a0,-1444 # 7cb8 <malloc+0x202c>
    5264:	00001097          	auipc	ra,0x1
    5268:	970080e7          	jalr	-1680(ra) # 5bd4 <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	a4e50513          	addi	a0,a0,-1458 # 7cf8 <malloc+0x206c>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	922080e7          	jalr	-1758(ra) # 5bd4 <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	a1e50513          	addi	a0,a0,-1506 # 7d18 <malloc+0x208c>
    5302:	00001097          	auipc	ra,0x1
    5306:	8d2080e7          	jalr	-1838(ra) # 5bd4 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a1650513          	addi	a0,a0,-1514 # 7d40 <malloc+0x20b4>
    5332:	00001097          	auipc	ra,0x1
    5336:	8a2080e7          	jalr	-1886(ra) # 5bd4 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	9da50513          	addi	a0,a0,-1574 # 7d28 <malloc+0x209c>
    5356:	00001097          	auipc	ra,0x1
    535a:	87e080e7          	jalr	-1922(ra) # 5bd4 <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	9d250513          	addi	a0,a0,-1582 # 7d48 <malloc+0x20bc>
    537e:	00001097          	auipc	ra,0x1
    5382:	856080e7          	jalr	-1962(ra) # 5bd4 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	da078793          	addi	a5,a5,-608 # 8160 <malloc+0x24d4>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	18430313          	addi	t1,t1,388 # 8550 <malloc+0x28c4>
  ...
  printf("usertests starting\n");
    ...
    5404:	a0050513          	addi	a0,a0,-1536 # 7e00 <malloc+0x2174>
    5408:	00000097          	auipc	ra,0x0
    540c:	7cc080e7          	jalr	1996(ra) # 5bd4 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	98050513          	addi	a0,a0,-1664 # 7db8 <malloc+0x212c>
    5440:	00000097          	auipc	ra,0x0
    5444:	794080e7          	jalr	1940(ra) # 5bd4 <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	8fc58593          	addi	a1,a1,-1796 # 7d50 <malloc+0x20c4>
    ...
    546e:	9ce58593          	addi	a1,a1,-1586 # 7e38 <malloc+0x21ac>
    ...
    5492:	8ca50513          	addi	a0,a0,-1846 # 7d58 <malloc+0x20cc>
    5496:	00000097          	auipc	ra,0x0
    549a:	73e080e7          	jalr	1854(ra) # 5bd4 <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	71c080e7          	jalr	1820(ra) # 5bd4 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	8a650513          	addi	a0,a0,-1882 # 7da0 <malloc+0x2114>
    5502:	00000097          	auipc	ra,0x0
    5506:	6d2080e7          	jalr	1746(ra) # 5bd4 <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	8d450513          	addi	a0,a0,-1836 # 7de8 <malloc+0x215c>
    551c:	00000097          	auipc	ra,0x0
    5520:	6b8080e7          	jalr	1720(ra) # 5bd4 <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	6a4080e7          	jalr	1700(ra) # 5bd4 <printf>
        if(continuous != 2)
    ...
    5576:	bee78793          	addi	a5,a5,-1042 # 8160 <malloc+0x24d4>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	fd230313          	addi	t1,t1,-46 # 8550 <malloc+0x28c4>
    ...
    55b6:	86650513          	addi	a0,a0,-1946 # 7e18 <malloc+0x218c>
    55ba:	00000097          	auipc	ra,0x0
    55be:	61a080e7          	jalr	1562(ra) # 5bd4 <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00002a97          	auipc	s5,0x2
    55c6:	7dea8a93          	addi	s5,s5,2014 # 7da0 <malloc+0x2114>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00002b17          	auipc	s6,0x2
    55d0:	7b4b0b13          	addi	s6,s6,1972 # 7d80 <malloc+0x20f4>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5910:	f56080e7          	jalr	-170(ra) # 5862 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    592e:	0805c963          	bltz	a1,59c0 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    5942:	c7250513          	addi	a0,a0,-910 # 85b0 <digits>
    5946:	883a                	mv	a6,a4
  ...
  if(neg)
    596a:	00088c63          	beqz	a7,5982 <printint+0x66>
    buf[i++] = '-';
    596e:	fd070793          	addi	a5,a4,-48
    5972:	00878733          	add	a4,a5,s0
    5976:	02d00793          	li	a5,45
    597a:	fef70823          	sb	a5,-16(a4)
    597e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5982:	02e05863          	blez	a4,59b2 <printint+0x96>
    ...
    59a8:	f56080e7          	jalr	-170(ra) # 58fa <putc>
  while(--i >= 0)
    59ac:	197d                	addi	s2,s2,-1
    59ae:	ff3918e3          	bne	s2,s3,599e <printint+0x82>
}
    ...
    59c4:	4885                	li	a7,1
    x = -xx;
    59c6:	bf85                	j	5936 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    59fc:	4c55                	li	s8,21
    59fe:	00003c97          	auipc	s9,0x3
    5a02:	b5ac8c93          	addi	s9,s9,-1190 # 8558 <malloc+0x28cc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5a06:	02800d93          	li	s11,40
  putc(fd, 'x');
    5a0a:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a0c:	00003b97          	auipc	s7,0x3
    5a10:	ba4b8b93          	addi	s7,s7,-1116 # 85b0 <digits>
    5a14:	a839                	j	5a32 <vprintf+0x6a>
        putc(fd, c);
    5a16:	85ca                	mv	a1,s2
    5a18:	8556                	mv	a0,s5
    5a1a:	00000097          	auipc	ra,0x0
    5a1e:	ee0080e7          	jalr	-288(ra) # 58fa <putc>
    5a22:	a019                	j	5a28 <vprintf+0x60>
    } else if(state == '%'){
    5a24:	01498d63          	beq	s3,s4,5a3e <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5a28:	0485                	addi	s1,s1,1
    5a2a:	fff4c903          	lbu	s2,-1(s1)
    5a2e:	14090d63          	beqz	s2,5b88 <vprintf+0x1c0>
    if(state == 0){
    5a32:	fe0999e3          	bnez	s3,5a24 <vprintf+0x5c>
      if(c == '%'){
    5a36:	ff4910e3          	bne	s2,s4,5a16 <vprintf+0x4e>
        state = '%';
    5a3a:	89d2                	mv	s3,s4
    5a3c:	b7f5                	j	5a28 <vprintf+0x60>
      if(c == 'd'){
    5a3e:	11490c63          	beq	s2,s4,5b56 <vprintf+0x18e>
    5a42:	f9d9079b          	addiw	a5,s2,-99
    5a46:	0ff7f793          	zext.b	a5,a5
    5a4a:	10fc6e63          	bltu	s8,a5,5b66 <vprintf+0x19e>
    5a4e:	f9d9079b          	addiw	a5,s2,-99
    5a52:	0ff7f713          	zext.b	a4,a5
    5a56:	10ec6863          	bltu	s8,a4,5b66 <vprintf+0x19e>
    5a5a:	00271793          	slli	a5,a4,0x2
    5a5e:	97e6                	add	a5,a5,s9
    5a60:	439c                	lw	a5,0(a5)
    5a62:	97e6                	add	a5,a5,s9
    5a64:	8782                	jr	a5
    ...
    5a78:	ea8080e7          	jalr	-344(ra) # 591c <printint>
    5a7c:	8b4a                	mv	s6,s2
      } else {
    ...
    5a94:	e8c080e7          	jalr	-372(ra) # 591c <printint>
    5a98:	8b4a                	mv	s6,s2
      state = 0;
    5a9a:	4981                	li	s3,0
    ...
    5ab0:	e70080e7          	jalr	-400(ra) # 591c <printint>
    5ab4:	8b4a                	mv	s6,s2
      state = 0;
    5ab6:	4981                	li	s3,0
    5ab8:	bf85                	j	5a28 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5aba:	008b0793          	addi	a5,s6,8
    5abe:	f8f43423          	sd	a5,-120(s0)
    5ac2:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5ac6:	03000593          	li	a1,48
    5aca:	8556                	mv	a0,s5
    5acc:	00000097          	auipc	ra,0x0
    5ad0:	e2e080e7          	jalr	-466(ra) # 58fa <putc>
  putc(fd, 'x');
    5ad4:	07800593          	li	a1,120
    5ad8:	8556                	mv	a0,s5
    5ada:	00000097          	auipc	ra,0x0
    5ade:	e20080e7          	jalr	-480(ra) # 58fa <putc>
    5ae2:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5ae4:	03c9d793          	srli	a5,s3,0x3c
    5ae8:	97de                	add	a5,a5,s7
    5aea:	0007c583          	lbu	a1,0(a5)
    5aee:	8556                	mv	a0,s5
    5af0:	00000097          	auipc	ra,0x0
    5af4:	e0a080e7          	jalr	-502(ra) # 58fa <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5af8:	0992                	slli	s3,s3,0x4
    5afa:	397d                	addiw	s2,s2,-1
    5afc:	fe0914e3          	bnez	s2,5ae4 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5b00:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b04:	4981                	li	s3,0
    5b06:	b70d                	j	5a28 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b08:	008b0913          	addi	s2,s6,8
    5b0c:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5b10:	02098163          	beqz	s3,5b32 <vprintf+0x16a>
        while(*s != 0){
    5b14:	0009c583          	lbu	a1,0(s3)
    5b18:	c5ad                	beqz	a1,5b82 <vprintf+0x1ba>
          putc(fd, *s);
    5b1a:	8556                	mv	a0,s5
    5b1c:	00000097          	auipc	ra,0x0
    5b20:	dde080e7          	jalr	-546(ra) # 58fa <putc>
          s++;
    5b24:	0985                	addi	s3,s3,1
        while(*s != 0){
    5b26:	0009c583          	lbu	a1,0(s3)
    5b2a:	f9e5                	bnez	a1,5b1a <vprintf+0x152>
        s = va_arg(ap, char*);
    5b2c:	8b4a                	mv	s6,s2
      state = 0;
    5b2e:	4981                	li	s3,0
    5b30:	bde5                	j	5a28 <vprintf+0x60>
          s = "(null)";
    5b32:	00003997          	auipc	s3,0x3
    5b36:	a1e98993          	addi	s3,s3,-1506 # 8550 <malloc+0x28c4>
        while(*s != 0){
    5b3a:	85ee                	mv	a1,s11
    5b3c:	bff9                	j	5b1a <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5b3e:	008b0913          	addi	s2,s6,8
    5b42:	000b4583          	lbu	a1,0(s6)
    5b46:	8556                	mv	a0,s5
    5b48:	00000097          	auipc	ra,0x0
    5b4c:	db2080e7          	jalr	-590(ra) # 58fa <putc>
    5b50:	8b4a                	mv	s6,s2
      state = 0;
    5b52:	4981                	li	s3,0
    5b54:	bdd1                	j	5a28 <vprintf+0x60>
        putc(fd, c);
    5b56:	85d2                	mv	a1,s4
    5b58:	8556                	mv	a0,s5
    5b5a:	00000097          	auipc	ra,0x0
    5b5e:	da0080e7          	jalr	-608(ra) # 58fa <putc>
      state = 0;
    5b62:	4981                	li	s3,0
    5b64:	b5d1                	j	5a28 <vprintf+0x60>
        putc(fd, '%');
    5b66:	85d2                	mv	a1,s4
    5b68:	8556                	mv	a0,s5
    5b6a:	00000097          	auipc	ra,0x0
    5b6e:	d90080e7          	jalr	-624(ra) # 58fa <putc>
        putc(fd, c);
    5b72:	85ca                	mv	a1,s2
    5b74:	8556                	mv	a0,s5
    5b76:	00000097          	auipc	ra,0x0
    5b7a:	d84080e7          	jalr	-636(ra) # 58fa <putc>
      state = 0;
    5b7e:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5c18:	9bc7b783          	ld	a5,-1604(a5) # 85d0 <freep>
    5c1c:	a02d                	j	5c46 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c1e:	4618                	lw	a4,8(a2)
    5c20:	9f2d                	addw	a4,a4,a1
    5c22:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c26:	6398                	ld	a4,0(a5)
    5c28:	6310                	ld	a2,0(a4)
    5c2a:	a83d                	j	5c68 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c2c:	ff852703          	lw	a4,-8(a0)
    5c30:	9f31                	addw	a4,a4,a2
    5c32:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c34:	ff053683          	ld	a3,-16(a0)
    5c38:	a091                	j	5c7c <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c3a:	6398                	ld	a4,0(a5)
    5c3c:	00e7e463          	bltu	a5,a4,5c44 <free+0x3a>
    5c40:	00e6ea63          	bltu	a3,a4,5c54 <free+0x4a>
{
    5c44:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c46:	fed7fae3          	bgeu	a5,a3,5c3a <free+0x30>
    5c4a:	6398                	ld	a4,0(a5)
    5c4c:	00e6e463          	bltu	a3,a4,5c54 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c50:	fee7eae3          	bltu	a5,a4,5c44 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c54:	ff852583          	lw	a1,-8(a0)
    5c58:	6390                	ld	a2,0(a5)
    5c5a:	02059813          	slli	a6,a1,0x20
    5c5e:	01c85713          	srli	a4,a6,0x1c
    5c62:	9736                	add	a4,a4,a3
    5c64:	fae60de3          	beq	a2,a4,5c1e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c68:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c6c:	4790                	lw	a2,8(a5)
    5c6e:	02061593          	slli	a1,a2,0x20
    5c72:	01c5d713          	srli	a4,a1,0x1c
    5c76:	973e                	add	a4,a4,a5
    5c78:	fae68ae3          	beq	a3,a4,5c2c <free+0x22>
    p->s.ptr = bp->s.ptr;
    5c7c:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5c7e:	00003717          	auipc	a4,0x3
    5c82:	94f73923          	sd	a5,-1710(a4) # 85d0 <freep>
}
    5c86:	6422                	ld	s0,8(sp)
    5c88:	0141                	addi	sp,sp,16
    5c8a:	8082                	ret

0000000000005c8c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5c98:	e852                	sd	s4,16(sp)
    5c9a:	e456                	sd	s5,8(sp)
    5c9c:	e05a                	sd	s6,0(sp)
    5c9e:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5ca0:	02051493          	slli	s1,a0,0x20
    5ca4:	9081                	srli	s1,s1,0x20
    5ca6:	04bd                	addi	s1,s1,15
    5ca8:	8091                	srli	s1,s1,0x4
    5caa:	0014899b          	addiw	s3,s1,1
    5cae:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cb0:	00003517          	auipc	a0,0x3
    5cb4:	92053503          	ld	a0,-1760(a0) # 85d0 <freep>
    5cb8:	c515                	beqz	a0,5ce4 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    5cbe:	02977f63          	bgeu	a4,s1,5cfc <malloc+0x70>
    5cc2:	8a4e                	mv	s4,s3
    5cc4:	0009871b          	sext.w	a4,s3
    5cc8:	6685                	lui	a3,0x1
    5cca:	00d77363          	bgeu	a4,a3,5cd0 <malloc+0x44>
    5cce:	6a05                	lui	s4,0x1
    5cd0:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cd4:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cd8:	00003917          	auipc	s2,0x3
    5cdc:	8f890913          	addi	s2,s2,-1800 # 85d0 <freep>
  if(p == (char*)-1)
    5ce0:	5afd                	li	s5,-1
    5ce2:	a895                	j	5d56 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5ce4:	00009797          	auipc	a5,0x9
    5ce8:	10c78793          	addi	a5,a5,268 # edf0 <base>
    5cec:	00003717          	auipc	a4,0x3
    5cf0:	8ef73223          	sd	a5,-1820(a4) # 85d0 <freep>
    5cf4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5cf6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5cfa:	b7e1                	j	5cc2 <malloc+0x36>
      if(p->s.size == nunits)
    5cfc:	02e48c63          	beq	s1,a4,5d34 <malloc+0xa8>
        p->s.size -= nunits;
    5d00:	4137073b          	subw	a4,a4,s3
    5d04:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d06:	02071693          	slli	a3,a4,0x20
    5d0a:	01c6d713          	srli	a4,a3,0x1c
    5d0e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d10:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d14:	00003717          	auipc	a4,0x3
    5d18:	8aa73e23          	sd	a0,-1860(a4) # 85d0 <freep>
      return (void*)(p + 1);
    5d1c:	01078513          	addi	a0,a5,16
    ...
    5d2a:	6a42                	ld	s4,16(sp)
    5d2c:	6aa2                	ld	s5,8(sp)
    5d2e:	6b02                	ld	s6,0(sp)
    5d30:	6121                	addi	sp,sp,64
    5d32:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d34:	6398                	ld	a4,0(a5)
    5d36:	e118                	sd	a4,0(a0)
    5d38:	bff1                	j	5d14 <malloc+0x88>
  hp->s.size = nu;
    5d3a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d3e:	0541                	addi	a0,a0,16
    5d40:	00000097          	auipc	ra,0x0
    5d44:	eca080e7          	jalr	-310(ra) # 5c0a <free>
  return freep;
    5d48:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d4c:	d971                	beqz	a0,5d20 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d4e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d50:	4798                	lw	a4,8(a5)
    5d52:	fa9775e3          	bgeu	a4,s1,5cfc <malloc+0x70>
    if(p == freep)
    5d56:	00093703          	ld	a4,0(s2)
    5d5a:	853e                	mv	a0,a5
    5d5c:	fef719e3          	bne	a4,a5,5d4e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d60:	8552                	mv	a0,s4
    5d62:	00000097          	auipc	ra,0x0
    5d66:	b68080e7          	jalr	-1176(ra) # 58ca <sbrk>
  if(p == (char*)-1)
    5d6a:	fd5518e3          	bne	a0,s5,5d3a <malloc+0xae>
        return 0;
    5d6e:	4501                	li	a0,0
    5d70:	bf45                	j	5d20 <malloc+0x94>
