...
putc(int fd, char c)
{
 ...
 452:	f36080e7          	jalr	-202(ra) # 384 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 484:	51050513          	addi	a0,a0,1296 # 990 <digits>
 488:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 544:	3f8c8c93          	addi	s9,s9,1016 # 938 <malloc+0x16a>
 ...
 552:	442b8b93          	addi	s7,s7,1090 # 990 <digits>
 ...
 678:	2bc98993          	addi	s3,s3,700 # 930 <malloc+0x162>
        while(*s != 0){
 67c:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 75a:	2627b783          	ld	a5,610(a5) # 9b8 <freep>
 ...
 782:	00e6ea63          	bltu	a3,a4,796 <free+0x4a>
{
 ...
 7c4:	1ef73c23          	sd	a5,504(a4) # 9b8 <freep>
}
 7c8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f6:	1c653503          	ld	a0,454(a0) # 9b8 <freep>
 ...
 81e:	19e90913          	addi	s2,s2,414 # 9b8 <freep>
  if(p == (char*)-1)
 822:	5afd                	li	s5,-1
 824:	a895                	j	898 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 826:	00000797          	auipc	a5,0x0
 82a:	19a78793          	addi	a5,a5,410 # 9c0 <base>
 ...
 85a:	16a73123          	sd	a0,354(a4) # 9b8 <freep>
      return (void*)(p + 1);
 ...
 8a8:	b48080e7          	jalr	-1208(ra) # 3ec <sbrk>
  if(p == (char*)-1)
