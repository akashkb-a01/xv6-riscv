...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	30858593          	addi	a1,a1,776 # 1318 <malloc+0xe6>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2c258593          	addi	a1,a1,706 # 1320 <malloc+0xee>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	29050513          	addi	a0,a0,656 # 1328 <malloc+0xf6>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	36470713          	addi	a4,a4,868 # 1428 <malloc+0x1f6>
    ...
    panic("runcmd");
      ...
      e2:	25250513          	addi	a0,a0,594 # 1330 <malloc+0xfe>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	23858593          	addi	a1,a1,568 # 1338 <malloc+0x106>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	042080e7          	jalr	66(ra) # 114c <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	1fc58593          	addi	a1,a1,508 # 1348 <malloc+0x116>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	ff6080e7          	jalr	-10(ra) # 114c <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	17650513          	addi	a0,a0,374 # 1358 <malloc+0x126>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	fae080e7          	jalr	-82(ra) # 1232 <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	f64080e7          	jalr	-156(ra) # 1232 <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f0a080e7          	jalr	-246(ra) # 1232 <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	ec4080e7          	jalr	-316(ra) # 1232 <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	e82080e7          	jalr	-382(ra) # 1232 <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	0de98993          	addi	s3,s3,222 # 14d8 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     464:	07898993          	addi	s3,s3,120 # 14d8 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d0:	00c98993          	addi	s3,s3,12 # 14d8 <whitespace>
     4d4:	00001a97          	auipc	s5,0x1
     4d8:	ffca8a93          	addi	s5,s5,-4 # 14d0 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     53c:	fa098993          	addi	s3,s3,-96 # 14d8 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ae:	dd6b8b93          	addi	s7,s7,-554 # 1380 <malloc+0x14e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c0:	da450513          	addi	a0,a0,-604 # 1360 <malloc+0x12e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a8:	ce460613          	addi	a2,a2,-796 # 1388 <malloc+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d8:	cd4b0b13          	addi	s6,s6,-812 # 13a8 <malloc+0x176>
  ...
  return ret;
     ...
     712:	c8250513          	addi	a0,a0,-894 # 1390 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     774:	c2850513          	addi	a0,a0,-984 # 1398 <malloc+0x166>
...
000000000000078e <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ae:	c0660613          	addi	a2,a2,-1018 # 13b0 <malloc+0x17e>
     7b2:	85ce                	mv	a1,s3
     7b4:	854a                	mv	a0,s2
...
00000000000007fc <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81e:	b9ea0a13          	addi	s4,s4,-1122 # 13b8 <malloc+0x186>
  ...
  if(peek(ps, es, ";")){
     ...
     854:	b7060613          	addi	a2,a2,-1168 # 13c0 <malloc+0x18e>
     858:	85ce                	mv	a1,s3
     85a:	854a                	mv	a0,s2
...
00000000000008a4 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8ba:	ad260613          	addi	a2,a2,-1326 # 1388 <malloc+0x156>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ea:	af260613          	addi	a2,a2,-1294 # 13d8 <malloc+0x1a6>
     8ee:	85ca                	mv	a1,s2
     8f0:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92c:	aa050513          	addi	a0,a0,-1376 # 13c8 <malloc+0x196>
     930:	fffff097          	auipc	ra,0xfffff
     934:	724080e7          	jalr	1828(ra) # 54 <panic>
    panic("syntax - missing )");
     938:	00001517          	auipc	a0,0x1
     93c:	aa850513          	addi	a0,a0,-1368 # 13e0 <malloc+0x1ae>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     968:	adc70713          	addi	a4,a4,-1316 # 1440 <malloc+0x20e>
...
00000000000009e0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a14:	9e860613          	addi	a2,a2,-1560 # 13f8 <malloc+0x1c6>
     a18:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4a:	9ba58593          	addi	a1,a1,-1606 # 1400 <malloc+0x1ce>
     a4e:	4509                	li	a0,2
     a50:	00000097          	auipc	ra,0x0
     a54:	6fc080e7          	jalr	1788(ra) # 114c <fprintf>
    panic("syntax");
     a58:	00001517          	auipc	a0,0x1
     a5c:	93850513          	addi	a0,a0,-1736 # 1390 <malloc+0x15e>
...
0000000000000a68 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7e:	99648493          	addi	s1,s1,-1642 # 1410 <malloc+0x1de>
     a82:	4589                	li	a1,2
     a84:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa4:	a4848493          	addi	s1,s1,-1464 # 14e8 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa8:	06300913          	li	s2,99
     aac:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     ab0:	00001a17          	auipc	s4,0x1
     ab4:	a3ba0a13          	addi	s4,s4,-1477 # 14eb <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab8:	00001a97          	auipc	s5,0x1
     abc:	960a8a93          	addi	s5,s5,-1696 # 1418 <malloc+0x1e6>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b34:	61c080e7          	jalr	1564(ra) # 114c <fprintf>
     b38:	bf79                	j	ad6 <main+0x6e>
      runcmd(parsecmd(buf));
     b3a:	00001517          	auipc	a0,0x1
     b3e:	9ae50513          	addi	a0,a0,-1618 # 14e8 <buf.0>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     eb6:	f36080e7          	jalr	-202(ra) # de8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee8:	5d450513          	addi	a0,a0,1492 # 14b8 <digits>
     eec:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fa8:	4bcc8c93          	addi	s9,s9,1212 # 1460 <malloc+0x22e>
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fb6:	506b8b93          	addi	s7,s7,1286 # 14b8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10dc:	38098993          	addi	s3,s3,896 # 1458 <malloc+0x226>
        while(*s != 0){
    10e0:	85ee                	mv	a1,s11
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11be:	3267b783          	ld	a5,806(a5) # 14e0 <freep>
    ...
    11e6:	00e6ea63          	bltu	a3,a4,11fa <free+0x4a>
{
  ...
  freep = p;
    ...
    1228:	2af73e23          	sd	a5,700(a4) # 14e0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    125a:	28a53503          	ld	a0,650(a0) # 14e0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1282:	26290913          	addi	s2,s2,610 # 14e0 <freep>
  if(p == (char*)-1)
    1286:	5afd                	li	s5,-1
    1288:	a895                	j	12fc <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    128a:	00000797          	auipc	a5,0x0
    128e:	2c678793          	addi	a5,a5,710 # 1550 <base>
    1292:	00000717          	auipc	a4,0x0
    1296:	24f73723          	sd	a5,590(a4) # 14e0 <freep>
    ...
    12be:	22a73323          	sd	a0,550(a4) # 14e0 <freep>
      return (void*)(p + 1);
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    130c:	b48080e7          	jalr	-1208(ra) # e50 <sbrk>
  if(p == (char*)-1)
