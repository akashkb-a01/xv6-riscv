...
forktest(void)
{
  ...
  3e:	41650513          	addi	a0,a0,1046 # 450 <waitpid+0xe>
  ...
  68:	3fc50513          	addi	a0,a0,1020 # 460 <waitpid+0x1e>
  ...
  b8:	3fc50513          	addi	a0,a0,1020 # 4b0 <waitpid+0x6e>
  ...
  d4:	3b050513          	addi	a0,a0,944 # 480 <waitpid+0x3e>
  ...
  ee:	3ae50513          	addi	a0,a0,942 # 498 <waitpid+0x56>
