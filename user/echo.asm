...
putc(int fd, char c)
{
 ...
 3de:	f36080e7          	jalr	-202(ra) # 310 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	4a450513          	addi	a0,a0,1188 # 8b0 <digits>
 414:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	38cc8c93          	addi	s9,s9,908 # 858 <malloc+0xfe>
 ...
 4de:	3d6b8b93          	addi	s7,s7,982 # 8b0 <digits>
 ...
 604:	25098993          	addi	s3,s3,592 # 850 <malloc+0xf6>
        while(*s != 0){
 608:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6e6:	1e67b783          	ld	a5,486(a5) # 8c8 <freep>
 ...
 70e:	00e6ea63          	bltu	a3,a4,722 <free+0x4a>
{
 ...
 750:	16f73e23          	sd	a5,380(a4) # 8c8 <freep>
}
 754:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 782:	14a53503          	ld	a0,330(a0) # 8c8 <freep>
 ...
 7aa:	12290913          	addi	s2,s2,290 # 8c8 <freep>
  if(p == (char*)-1)
 7ae:	5afd                	li	s5,-1
 7b0:	a895                	j	824 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7b2:	00000797          	auipc	a5,0x0
 7b6:	11e78793          	addi	a5,a5,286 # 8d0 <base>
 7ba:	00000717          	auipc	a4,0x0
 7be:	10f73723          	sd	a5,270(a4) # 8c8 <freep>
 7c2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e6:	0ea73323          	sd	a0,230(a4) # 8c8 <freep>
      return (void*)(p + 1);
 ...
 834:	b48080e7          	jalr	-1208(ra) # 378 <sbrk>
  if(p == (char*)-1)
