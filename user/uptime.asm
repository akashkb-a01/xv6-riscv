...
main(int argc, char *argv[])
{
  ...
  16:	7d650513          	addi	a0,a0,2006 # 7e8 <malloc+0xe6>
  1a:	00000097          	auipc	ra,0x0
  1e:	630080e7          	jalr	1584(ra) # 64a <printf>
  exit(0);
  22:	4501                	li	a0,0
...
free(void *ap)
{
 ...
 68e:	1de7b783          	ld	a5,478(a5) # 868 <freep>
 ...
 6b6:	00e6ea63          	bltu	a3,a4,6ca <free+0x4a>
{
 ...
 6f8:	16f73a23          	sd	a5,372(a4) # 868 <freep>
}
 6fc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72a:	14253503          	ld	a0,322(a0) # 868 <freep>
 ...
 752:	11a90913          	addi	s2,s2,282 # 868 <freep>
  if(p == (char*)-1)
 756:	5afd                	li	s5,-1
 758:	a895                	j	7cc <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 75a:	00000797          	auipc	a5,0x0
 75e:	11678793          	addi	a5,a5,278 # 870 <base>
 762:	00000717          	auipc	a4,0x0
 766:	10f73323          	sd	a5,262(a4) # 868 <freep>
 76a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78e:	0ca73f23          	sd	a0,222(a4) # 868 <freep>
      return (void*)(p + 1);
 ...
 7dc:	b48080e7          	jalr	-1208(ra) # 320 <sbrk>
  if(p == (char*)-1)
