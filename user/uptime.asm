...
main(int argc, char *argv[])
{
  ...
  16:	7c650513          	addi	a0,a0,1990 # 7d8 <malloc+0xe6>
...
free(void *ap)
{
 ...
 67e:	1de7b783          	ld	a5,478(a5) # 858 <freep>
 ...
 6a6:	00e6ea63          	bltu	a3,a4,6ba <free+0x4a>
{
 ...
 6e8:	16f73a23          	sd	a5,372(a4) # 858 <freep>
}
 6ec:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71a:	14253503          	ld	a0,322(a0) # 858 <freep>
 ...
 742:	11a90913          	addi	s2,s2,282 # 858 <freep>
  if(p == (char*)-1)
 746:	5afd                	li	s5,-1
 748:	a895                	j	7bc <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 74a:	00000797          	auipc	a5,0x0
 74e:	11678793          	addi	a5,a5,278 # 860 <base>
 752:	00000717          	auipc	a4,0x0
 756:	10f73323          	sd	a5,262(a4) # 858 <freep>
 75a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 77e:	0ca73f23          	sd	a0,222(a4) # 858 <freep>
      return (void*)(p + 1);
 ...
 7cc:	b58080e7          	jalr	-1192(ra) # 320 <sbrk>
  if(p == (char*)-1)
