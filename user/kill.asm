...
putc(int fd, char c)
{
 ...
 3be:	f36080e7          	jalr	-202(ra) # 2f0 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f0:	4ac50513          	addi	a0,a0,1196 # 898 <digits>
 3f4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b0:	394c8c93          	addi	s9,s9,916 # 840 <malloc+0x106>
 ...
 4be:	3deb8b93          	addi	s7,s7,990 # 898 <digits>
 ...
 5e4:	25898993          	addi	s3,s3,600 # 838 <malloc+0xfe>
        while(*s != 0){
 5e8:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6c6:	1ee7b783          	ld	a5,494(a5) # 8b0 <freep>
 ...
 6ee:	00e6ea63          	bltu	a3,a4,702 <free+0x4a>
{
 ...
 730:	18f73223          	sd	a5,388(a4) # 8b0 <freep>
}
 734:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 762:	15253503          	ld	a0,338(a0) # 8b0 <freep>
 ...
 78a:	12a90913          	addi	s2,s2,298 # 8b0 <freep>
  if(p == (char*)-1)
 78e:	5afd                	li	s5,-1
 790:	a895                	j	804 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 792:	00000797          	auipc	a5,0x0
 796:	12678793          	addi	a5,a5,294 # 8b8 <base>
 79a:	00000717          	auipc	a4,0x0
 79e:	10f73b23          	sd	a5,278(a4) # 8b0 <freep>
 7a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c6:	0ea73723          	sd	a0,238(a4) # 8b0 <freep>
      return (void*)(p + 1);
 ...
 814:	b48080e7          	jalr	-1208(ra) # 358 <sbrk>
  if(p == (char*)-1)
