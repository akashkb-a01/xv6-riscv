...
main(int argc, char *argv[])
{
  ...
  1a:	8c278793          	addi	a5,a5,-1854 # 8d8 <malloc+0x116>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	87c50513          	addi	a0,a0,-1924 # 8a8 <malloc+0xe6>
  ...
  6c:	85850513          	addi	a0,a0,-1960 # 8c0 <malloc+0xfe>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	81a50513          	addi	a0,a0,-2022 # 8d0 <malloc+0x10e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 478:	4d450513          	addi	a0,a0,1236 # 948 <digits>
 47c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 538:	3bcc8c93          	addi	s9,s9,956 # 8f0 <malloc+0x12e>
 ...
 546:	406b8b93          	addi	s7,s7,1030 # 948 <digits>
 ...
 66c:	28098993          	addi	s3,s3,640 # 8e8 <malloc+0x126>
        while(*s != 0){
 670:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 74e:	2167b783          	ld	a5,534(a5) # 960 <freep>
 ...
 776:	00e6ea63          	bltu	a3,a4,78a <free+0x4a>
{
 ...
 7b8:	1af73623          	sd	a5,428(a4) # 960 <freep>
}
 7bc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ea:	17a53503          	ld	a0,378(a0) # 960 <freep>
 ...
 812:	15290913          	addi	s2,s2,338 # 960 <freep>
  if(p == (char*)-1)
 816:	5afd                	li	s5,-1
 818:	a895                	j	88c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 81a:	00000797          	auipc	a5,0x0
 81e:	14e78793          	addi	a5,a5,334 # 968 <base>
 822:	00000717          	auipc	a4,0x0
 826:	12f73f23          	sd	a5,318(a4) # 960 <freep>
 82a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 84e:	10a73b23          	sd	a0,278(a4) # 960 <freep>
      return (void*)(p + 1);
 ...
 89c:	b68080e7          	jalr	-1176(ra) # 400 <sbrk>
  if(p == (char*)-1)
