...
cat(int fd)
{
  ...
  44:	88058593          	addi	a1,a1,-1920 # 8c0 <malloc+0xec>
  48:	4509                	li	a0,2
  ...
  72:	86a58593          	addi	a1,a1,-1942 # 8d8 <malloc+0x104>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	7ee58593          	addi	a1,a1,2030 # 8f0 <malloc+0x11c>
 10a:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 458:	f56080e7          	jalr	-170(ra) # 3aa <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	4e250513          	addi	a0,a0,1250 # 968 <digits>
 48e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54a:	3cac8c93          	addi	s9,s9,970 # 910 <malloc+0x13c>
 ...
 558:	414b8b93          	addi	s7,s7,1044 # 968 <digits>
 ...
 67e:	28e98993          	addi	s3,s3,654 # 908 <malloc+0x134>
        while(*s != 0){
 682:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 760:	2247b783          	ld	a5,548(a5) # 980 <freep>
 ...
 788:	00e6ea63          	bltu	a3,a4,79c <free+0x4a>
{
 ...
 7ca:	1af73d23          	sd	a5,442(a4) # 980 <freep>
}
 7ce:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7fc:	18853503          	ld	a0,392(a0) # 980 <freep>
 ...
 824:	16090913          	addi	s2,s2,352 # 980 <freep>
  if(p == (char*)-1)
 828:	5afd                	li	s5,-1
 82a:	a895                	j	89e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 82c:	00000797          	auipc	a5,0x0
 830:	35c78793          	addi	a5,a5,860 # b88 <base>
 ...
 860:	12a73223          	sd	a0,292(a4) # 980 <freep>
      return (void*)(p + 1);
 ...
 8ae:	b68080e7          	jalr	-1176(ra) # 412 <sbrk>
  if(p == (char*)-1)
