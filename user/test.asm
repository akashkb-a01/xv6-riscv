...
int main(int argc, char const *argv[])
{
  ...
  10:	ed11                	bnez	a0,2c <main+0x2c>
        printf("C\n");
  12:	00000517          	auipc	a0,0x0
  16:	7ce50513          	addi	a0,a0,1998 # 7e0 <malloc+0xec>
  ...
  30:	32e080e7          	jalr	814(ra) # 35a <yield>
        printf("P\n");
  34:	00000517          	auipc	a0,0x0
  38:	7b450513          	addi	a0,a0,1972 # 7e8 <malloc+0xf4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3aa:	4aa50513          	addi	a0,a0,1194 # 850 <digits>
 3ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 46a:	392c8c93          	addi	s9,s9,914 # 7f8 <malloc+0x104>
 ...
 478:	3dcb8b93          	addi	s7,s7,988 # 850 <digits>
 ...
 59e:	25698993          	addi	s3,s3,598 # 7f0 <malloc+0xfc>
        while(*s != 0){
 5a2:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 680:	1ec7b783          	ld	a5,492(a5) # 868 <freep>
 ...
 6a8:	00e6ea63          	bltu	a3,a4,6bc <free+0x4a>
{
 ...
 6ea:	18f73123          	sd	a5,386(a4) # 868 <freep>
}
 6ee:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71c:	15053503          	ld	a0,336(a0) # 868 <freep>
 ...
 744:	12890913          	addi	s2,s2,296 # 868 <freep>
  if(p == (char*)-1)
 748:	5afd                	li	s5,-1
 74a:	a895                	j	7be <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 74c:	00000797          	auipc	a5,0x0
 750:	12478793          	addi	a5,a5,292 # 870 <base>
 754:	00000717          	auipc	a4,0x0
 758:	10f73a23          	sd	a5,276(a4) # 868 <freep>
 75c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 780:	0ea73623          	sd	a0,236(a4) # 868 <freep>
      return (void*)(p + 1);
