...
int main(int argc, char const *argv[])
{
   ...
   e:	2d8080e7          	jalr	728(ra) # 2e2 <fork>
    if(x == 0){
  12:	e131                	bnez	a0,56 <main+0x56>
        printf("%d: Child Here\n", getpid());
  14:	00000097          	auipc	ra,0x0
  18:	356080e7          	jalr	854(ra) # 36a <getpid>
  1c:	85aa                	mv	a1,a0
  1e:	00001517          	auipc	a0,0x1
  22:	80a50513          	addi	a0,a0,-2038 # 828 <malloc+0xec>
  26:	00000097          	auipc	ra,0x0
  2a:	65e080e7          	jalr	1630(ra) # 684 <printf>
        x = fork();
  2e:	00000097          	auipc	ra,0x0
  32:	2b4080e7          	jalr	692(ra) # 2e2 <fork>
        if(x == 0) printf("%d\n", getpid());
  36:	c111                	beqz	a0,3a <main+0x3a>
        else{
            // printf("%d\n", getpid());
            while(1);
  38:	a001                	j	38 <main+0x38>
        if(x == 0) printf("%d\n", getpid());
  3a:	00000097          	auipc	ra,0x0
  3e:	330080e7          	jalr	816(ra) # 36a <getpid>
  42:	85aa                	mv	a1,a0
  44:	00000517          	auipc	a0,0x0
  48:	7f450513          	addi	a0,a0,2036 # 838 <malloc+0xfc>
  4c:	00000097          	auipc	ra,0x0
  50:	638080e7          	jalr	1592(ra) # 684 <printf>
  54:	a005                	j	74 <main+0x74>
  56:	84aa                	mv	s1,a0
        }
    }
    else{
  ...
  5e:	348080e7          	jalr	840(ra) # 3a2 <waitpid>
        printf("%d: Child Not here\n", x);
  62:	85a6                	mv	a1,s1
  64:	00000517          	auipc	a0,0x0
  68:	7dc50513          	addi	a0,a0,2012 # 840 <malloc+0x104>
  6c:	00000097          	auipc	ra,0x0
  70:	618080e7          	jalr	1560(ra) # 684 <printf>
    }
    exit(0);
  74:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f2:	4ca50513          	addi	a0,a0,1226 # 8b8 <digits>
 3f6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b2:	3b2c8c93          	addi	s9,s9,946 # 860 <malloc+0x124>
 ...
 4c0:	3fcb8b93          	addi	s7,s7,1020 # 8b8 <digits>
 ...
 5e6:	27698993          	addi	s3,s3,630 # 858 <malloc+0x11c>
        while(*s != 0){
 5ea:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6c8:	20c7b783          	ld	a5,524(a5) # 8d0 <freep>
 ...
 6f0:	00e6ea63          	bltu	a3,a4,704 <free+0x4a>
{
 ...
 732:	1af73123          	sd	a5,418(a4) # 8d0 <freep>
}
 736:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 764:	17053503          	ld	a0,368(a0) # 8d0 <freep>
 ...
 78c:	14890913          	addi	s2,s2,328 # 8d0 <freep>
  if(p == (char*)-1)
 790:	5afd                	li	s5,-1
 792:	a895                	j	806 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 794:	00000797          	auipc	a5,0x0
 798:	14478793          	addi	a5,a5,324 # 8d8 <base>
 79c:	00000717          	auipc	a4,0x0
 7a0:	12f73a23          	sd	a5,308(a4) # 8d0 <freep>
 7a4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c8:	10a73623          	sd	a0,268(a4) # 8d0 <freep>
      return (void*)(p + 1);
